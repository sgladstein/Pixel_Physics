...
| 12 | Grass does not spread — a sown patch is the patch you keep, so an ideal area never fills in. Owner-filed 2026-08-24 from a review verdict; environment (light via `noon_equivalent_light`, temperature, canopy) must gate it, and it has to be judged *after* a burn as well as on virgin ground | feature, worldgen, plants |
