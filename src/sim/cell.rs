...
pub struct Cell {
    ...
    ///
    ///   This line used to say "unused, always 0", which was true when it
    ///   was written and had stopped being true by the time infiltration
    ///   wrote it; the render path read the whole union as if it were this
    ///   entry and drew every stone cell's *anchor distance* as dampness.
