...
impl World {
    ...
    /// This world's current weather — read on the **weather** clock, which is
    /// independent of the day's (`sim::clock::Clock::weather_slowdown`).
    pub fn weather(&self) -> crate::sim::weather::Weather {
        crate::sim::weather::at(self.seed, self.weather_frame())
    }
