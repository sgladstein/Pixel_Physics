...
| **`Reports/lanes/evolution-lab-coordinator.md`** | **Working on the lab? Start here and nowhere else.** `cargo run --release --bin lab` is the second game — a sealed box of soil under grow lights where the shipped plants and ants live. This note carries who owns which file, the decisions the owner has already taken, and **what each round *overturned*, which is the part a later session cannot reconstruct**. The design of record is `Reports/evolution-lab-design-guide-2026-08-30.md`; **until PR #158 lands it is on a branch and grep cannot find it** — `git show origin/claude/evolution-lab-game-concept-q2rayk:Reports/evolution-lab-design-guide-2026-08-30.md` |
