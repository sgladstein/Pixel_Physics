...
| `Reports/dead-ends.md` | **Tried-and-reverted approaches** (544 at last census), each with the condition its rejection depended on and where the full record lives — grep your area before proposing or retrying anything in it |
