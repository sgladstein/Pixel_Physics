...
plant that cannot pay sheds it). Written when water became a real currency and
...
lasting for ever. Updated most recently when standing wood started costing
carbon to keep, night started slowing growth, and a root buried inside its
own root ball stopped counting for anything — see **What a plant pays for**,
which is new. One plant-economy number is unsettled and its cause is still
open — see `Reports/open-bugs-handoff.md`.*
