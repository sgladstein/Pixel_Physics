...
mattering. Accurate as of that change.
...
fork repeatedly into a mound or hold a single leader. Each species declares a
range of foliage and bark colours and an individual draws from inside it, so a
stand of one species is a family rather than a row of clones.
