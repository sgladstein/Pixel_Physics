...
*Current as of: 2026-09-06, when **an animal being bitten started leaving a
smell where it happened**, and when **biting something you are not going to
eat became a thing an animal can decide to do**. Neither shows on screen yet:
no ant is born knowing what a cry of alarm means or when to pick a fight, and
both are things a line has to grow into. Earlier the same day, **how far a
lineage may get from its
