...
puddle** and **a nest became a place that holds a smell**. The worked ground a
colony walks home to used to be the one piece of the bed that could not soak up
water; every misting left a film sitting on it, and since nothing walks into
water, the whole colony simply lost its front door — food kept being picked up
and none of it ever came home. The threshold has drains in it now: every third
column of it is left as ordinary ground, so a film has one cell to travel
before the earth drinks it. The door looks very slightly speckled and is
otherwise the same place; a thin sheen can still catch on it after heavy
misting. See "Coming home" below. The same day, ants began to blend with the
mound they stand on, scent drift shipped at last, and two mounds nobody walks
between became two colonies within a session — see "Who is family". Earlier,
2026-09-11, evening, when **a bed was built for the flitter
...
looks like a bug in the game. That is not a figure of speech — the whole
way ants organise themselves needs a crowd, and a handful of them milling
...
B** (the food trail, cyan). Trails are a single cell wide, so the overlay
