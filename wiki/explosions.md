...
is simply gone, vaporized outright; further out, material is hurled away
as flying debris instead — and only some of it, not everything caught in
range, so the ground near a blast reads as thinned and cratered rather
than perfectly swept clean.

**A charge now reads its surroundings, direction by direction.** Where
...
charge, and liquids don't confine a blast at all — a charge underwater
behaves like a charge in the open.

Debris pays attention to what's actually around it: it vents out through
open corners and corridors rather than punching straight through walls it
isn't strong enough to touch, and a charge buried under a modest amount of
cover can still throw material out through it rather than being fully
contained.

Just past the crater's edge, a fading shockwave can pick up loose,
unanchored material — sand, water — even if it wasn't directly touched by
the blast, while solid rock stays put. Beyond that, a ring of heat lights
