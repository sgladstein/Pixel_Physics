...
- [ant-scenes-2026-09-23.md](ant-scenes-2026-09-23.md)
  ...
  - **In the lab box** (§14, 12 seeds): the new walk carries home 3.7×
    ...
    bare and go extinct (0 today), and +9% on the ant scene's frame.
  - **Made the default** (§15, owner's ruling 2026-09-24), with the drop
    wires, for species that name a nest; `PIXEL_PHYSICS_CHOOSER=off` is the
