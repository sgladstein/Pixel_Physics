...
- [felling-blockers.md](felling-blockers.md) — **scope only, nothing
  built.** What would have to be true before a tree can be cut down and
  topple. The blocker is the organism support model, not the verb: it asks
  "am I within 8 hops of stone" where felling needs "can this tree reach
  its roots". Read before proposing a chop; two of its items are redesigns
  wearing the costume of constants.
