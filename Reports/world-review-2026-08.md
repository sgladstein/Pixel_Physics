...
**Contents** — 8 sections, ~12,074 tokens. Read a section, not the file: the line number is there so you can `sed -n 'START,ENDp'` it, and the token column is there so that is a priced decision rather than a guess. Regenerated by `scripts/reporttoc.py`; a merge conflict inside this block is never hand-merged — take either side whole and re-run.

| Section | Line | ~tokens |
|---|---|---|
| [§1 What the images show](#1-what-the-images-show) | 47 | 1,316 |
| [§2 What the six lenses found (kept findings only)](#2-what-the-six-lenses-found-kept-findings-only) | 131 | 2,308 |
| [§3 Prosecutor verdicts — what got killed or corrected](#3-prosecutor-verdicts--what-got-killed-or-corrected) | 288 | 699 |
| [§4 Rivers and waterfalls: yes — and the repo already did the hard thinking](#4-rivers-and-waterfalls-yes--and-the-repo-already-did-the-hard-thinking) | 334 | 2,901 |
| [§5 Roadmap](#5-roadmap) | 516 | 2,126 |
| [§6 Open questions for the owner](#6-open-questions-for-the-owner) | 666 | 323 |
| [§7 Landmines appendix — for the implementation model](#7-landmines-appendix--for-the-implementation-model) | 689 | 1,143 |
| [Where things stand — overnight autonomous block, 2026-08-20](#where-things-stand--overnight-autonomous-block-2026-08-20) | 766 | 504 |
