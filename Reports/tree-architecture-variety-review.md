...
**Contents** — 7 sections, ~14,228 tokens. Read a section, not the file: the line number is there so you can `sed -n 'START,ENDp'` it, and the token column is there so that is a priced decision rather than a guess. Regenerated by `scripts/reporttoc.py`; a merge conflict inside this block is never hand-merged — take either side whole and re-run.

| Section | Line | ~tokens |
|---|---|---|
| [0. The findings, stated first](#0-the-findings-stated-first) | 34 | 734 |
| [1. `FieldTile::occupancy` — the invariant change (concern A)](#1-fieldtileoccupancy--the-invariant-change-concern-a) | 84 | 1,779 |
| [2. The six concerns, answered](#2-the-six-concerns-answered) | 223 | 4,281 |
| [3. Real growth variety — the main ask](#3-real-growth-variety--the-main-ask) | 548 | 4,579 |
| [4. Recommendations, ranked by silhouette impact per unit of complexity](#4-recommendations-ranked-by-silhouette-impact-per-unit-of-complexity) | 920 | 869 |
| [5. Measured vs argued](#5-measured-vs-argued) | 962 | 643 |
| [6. Sources](#6-sources) | 1014 | 855 |
