...
**Contents** — 13 sections, ~14,368 tokens. Read a section, not the file: the line number is there so you can `sed -n 'START,ENDp'` it, and the token column is there so that is a priced decision rather than a guess. Regenerated by `scripts/reporttoc.py`; a merge conflict inside this block is never hand-merged — take either side whole and re-run.

| Section | Line | ~tokens |
|---|---|---|
| [0. Read the previous review's method before forming findings](#0-read-the-previous-reviews-method-before-forming-findings) | 66 | 405 |
| [1. The earlier audit is done, not pending — check this before re-running it](#1-the-earlier-audit-is-done-not-pending--check-this-before-re-running-it) | 93 | 301 |
| [1b. The cold-agent benchmark, re-run — 6 file-opens against a baseline of 8](#1b-the-cold-agent-benchmark-re-run--6-file-opens-against-a-baseline-of-8) | 114 | 901 |
| [2. The corpus, measured](#2-the-corpus-measured) | 182 | 397 |
| [3. CLAUDE.md: the always-loaded budget](#3-claudemd-the-always-loaded-budget) | 222 | 532 |
| [4. The bug register — fixed this pass](#4-the-bug-register--fixed-this-pass) | 275 | 1,127 |
| [5. Not yet acted on — proposals](#5-not-yet-acted-on--proposals) | 349 | 3,800 |
| [6. This pass was itself reviewed, and the review found real defects](#6-this-pass-was-itself-reviewed-and-the-review-found-real-defects) | 601 | 970 |
| [7. What this pass changed](#7-what-this-pass-changed) | 668 | 462 |
| [8. Verification](#8-verification) | 700 | 297 |
| [9. README.md audited against the agent lens — verdict: keep it](#9-readmemd-audited-against-the-agent-lens--verdict-keep-it) | 728 | 1,851 |
| [10. Doc staleness, measured across the whole corpus — mostly a negative result](#10-doc-staleness-measured-across-the-whole-corpus--mostly-a-negative-result) | 877 | 1,090 |
| [11. PLAN.md audited — and the address space that turned out to span two documents](#11-planmd-audited--and-the-address-space-that-turned-out-to-span-two-documents) | 950 | 1,087 |
