...
**Contents** — 11 sections, ~25,593 tokens. Read a section, not the file: the line number is there so you can `sed -n 'START,ENDp'` it, and the token column is there so that is a priced decision rather than a guess. Regenerated by `scripts/reporttoc.py`; a merge conflict inside this block is never hand-merged — take either side whole and re-run.

| Section | Line | ~tokens |
|---|---|---|
| [Ground rules (non-negotiable)](#ground-rules-non-negotiable) | 33 | 692 |
| [Task 1 — Step-0 measurements (findings only, no behavior changes)](#task-1--step-0-measurements-findings-only-no-behavior-changes) | 80 | 585 |
| [Task 2 — 16-seed worldgen census sweep (`scripts/worldgen_sweep.sh`)](#task-2--16-seed-worldgen-census-sweep-scriptsworldgensweepsh) | 119 | 340 |
| [Task 3 — Region-keyed palettes (regions become biomes, step 1)](#task-3--region-keyed-palettes-regions-become-biomes-step-1) | 144 | 429 |
| [Task 4 — Pockets follow bedding + gravel legibility](#task-4--pockets-follow-bedding--gravel-legibility) | 174 | 382 |
| [Task 5 — Dune-comb and plumb-riser legibility fixes](#task-5--dune-comb-and-plumb-riser-legibility-fixes) | 201 | 398 |
| [Task 6 — Brows/talus rescue at region scale](#task-6--browstalus-rescue-at-region-scale) | 229 | 358 |
| [After task 6](#after-task-6) | 256 | 74 |
| [Findings](#findings) | 263 | 16,484 |
| [Track summary — what changed, and what the next session should know](#track-summary--what-changed-and-what-the-next-session-should-know) | 1461 | 919 |
| [Round-2 summary — four tasks, four commits, and what the reviewer owns](#round-2-summary--four-tasks-four-commits-and-what-the-reviewer-owns) | 1524 | 4,314 |
