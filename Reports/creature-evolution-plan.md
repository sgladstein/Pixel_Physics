...
| [4. Standing guards](#4-standing-guards) | 1322 | 2,622 |
| [5. Deferred, and why](#5-deferred-and-why) | 1495 | 354 |
| [6. The dead-end register](#6-the-dead-end-register) | 1520 | 818 |
| [7. Is open-ended reachable, and what would it additionally require](#7-is-open-ended-reachable-and-what-would-it-additionally-require) | 1544 | 653 |
| [8. Open questions for the owner](#8-open-questions-for-the-owner) | 1588 | 1,278 |
| [9. Provenance](#9-provenance) | 1673 | 196 |
...
> → 24, deepest 18 → 37**. Full account, including why `eats 6 / deaths 0`
> does not mean the world feeds the colony for free, in
> `Reports/creature-rebaseline-2026-08-29.md`. The `Foraging pays`,
> `Ants fed` and `Reference genomes` rows below have **not** been re-measured
> on `ba6fc98` and should be treated as unchecked until they are.
