...
**Contents** — 10 sections, ~25,105 tokens. Read a section, not the file: the line number is there so you can `sed -n 'START,ENDp'` it, and the token column is there so that is a priced decision rather than a guess. Regenerated by `scripts/reporttoc.py`; a merge conflict inside this block is never hand-merged — take either side whole and re-run.

| Section | Line | ~tokens |
|---|---|---|
| [0. Decision log](#0-decision-log) | 45 | 576 |
| [1. What is being built, in one page](#1-what-is-being-built-in-one-page) | 60 | 478 |
| [2. The stages](#2-the-stages) | 95 | 17,171 |
| [3. What each stage needs from the ones before it](#3-what-each-stage-needs-from-the-ones-before-it) | 1304 | 171 |
| [4. Standing guards](#4-standing-guards) | 1322 | 2,785 |
| [5. Deferred, and why](#5-deferred-and-why) | 1505 | 354 |
| [6. The dead-end register](#6-the-dead-end-register) | 1530 | 818 |
| [7. Is open-ended reachable, and what would it additionally require](#7-is-open-ended-reachable-and-what-would-it-additionally-require) | 1554 | 653 |
| [8. Open questions for the owner](#8-open-questions-for-the-owner) | 1598 | 1,278 |
| [9. Provenance](#9-provenance) | 1683 | 196 |
