...
**Contents** — 15 sections, ~11,424 tokens. Read a section, not the file: the line number is there so you can `sed -n 'START,ENDp'` it, and the token column is there so that is a priced decision rather than a guess. Regenerated by `scripts/reporttoc.py`; a merge conflict inside this block is never hand-merged — take either side whole and re-run.

| Section | Line | ~tokens |
|---|---|---|
| [1. Grass: a layer, not a fifth woody species](#1-grass-a-layer-not-a-fifth-woody-species) | 35 | 849 |
| [2. What it produces, paired against main in the same session](#2-what-it-produces-paired-against-main-in-the-same-session) | 96 | 379 |
| [3. The guards, and the check that they guard anything](#3-the-guards-and-the-check-that-they-guard-anything) | 126 | 449 |
| [4. The A4 two-patch divergence instrument](#4-the-a4-two-patch-divergence-instrument) | 164 | 748 |
| [5. The control: exactly zero, against a metric that is not flat](#5-the-control-exactly-zero-against-a-metric-that-is-not-flat) | 222 | 230 |
| [6. Two traps the instrument now reports on, both found by running it](#6-two-traps-the-instrument-now-reports-on-both-found-by-running-it) | 242 | 392 |
| [7. What it says about moisture — one result and one refusal](#7-what-it-says-about-moisture--one-result-and-one-refusal) | 267 | 555 |
| [8. What it takes to point this at wind](#8-what-it-takes-to-point-this-at-wind) | 311 | 427 |
| [9. Grass is a transient in a mature world, and the control says why](#9-grass-is-a-transient-in-a-mature-world-and-the-control-says-why) | 340 | 602 |
| [10. Cost](#10-cost) | 384 | 647 |
| [11. Grass does not read at world scale, and the card is how that was found](#11-grass-does-not-read-at-world-scale-and-the-card-is-how-that-was-found) | 431 | 653 |
| [12. What this leaves open](#12-what-this-leaves-open) | 485 | 237 |
| [13. Follow-up, 2026-08-24: the density call, and what it cost](#13-follow-up-2026-08-24-the-density-call-and-what-it-cost) | 505 | 1,154 |
| [14. "How long does it take to fill an ideal area" — it does not](#14-how-long-does-it-take-to-fill-an-ideal-area--it-does-not) | 586 | 1,293 |
| [15. Handoff](#15-handoff) | 680 | 2,117 |
