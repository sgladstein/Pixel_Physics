...
**Contents** — 13 sections, ~15,873 tokens. Read a section, not the file: the line number is there so you can `sed -n 'START,ENDp'` it, and the token column is there so that is a priced decision rather than a guess. Regenerated by `scripts/reporttoc.py`; a merge conflict inside this block is never hand-merged — take either side whole and re-run.

| Section | Line | ~tokens |
|---|---|---|
| [0. The one-page finding](#0-the-one-page-finding) | 55 | 384 |
| [1. The two evolution programmes, compared](#1-the-two-evolution-programmes-compared) | 85 | 2,066 |
| [2. Where the programmes must converge — the trophic seam](#2-where-the-programmes-must-converge--the-trophic-seam) | 207 | 587 |
| [3. The materials question: how a plant stops being wood](#3-the-materials-question-how-a-plant-stops-being-wood) | 247 | 1,778 |
| [4. Which plants are worth having](#4-which-plants-are-worth-having) | 380 | 506 |
| [4a. The Grow body plan: the expressible envelope](#4a-the-grow-body-plan-the-expressible-envelope) | 414 | 3,442 |
| [4b. What the side-view orientation costs and buys](#4b-what-the-side-view-orientation-costs-and-buys) | 649 | 725 |
| [5. Plant ecology: what exists, what is missing](#5-plant-ecology-what-exists-what-is-missing) | 699 | 1,065 |
| [6. Speciation: what it can mean here, and how to know it happened](#6-speciation-what-it-can-mean-here-and-how-to-know-it-happened) | 782 | 874 |
| [6a. Can the forms themselves emerge? — the framework assessment](#6a-can-the-forms-themselves-emerge--the-framework-assessment) | 842 | 1,049 |
| [7. Staging](#7-staging) | 912 | 806 |
| [8. NUMBERED CALLS FOR THE OWNER](#8-numbered-calls-for-the-owner) | 968 | 1,430 |
| [9. Provenance](#9-provenance) | 1061 | 244 |
