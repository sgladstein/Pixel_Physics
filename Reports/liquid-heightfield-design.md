...
**Contents** — 17 sections, ~19,056 tokens. Read a section, not the file: the line number is there so you can `sed -n 'START,ENDp'` it, and the token column is there so that is a priced decision rather than a guess. Regenerated by `scripts/reporttoc.py`; a merge conflict inside this block is never hand-merged — take either side whole and re-run.

| Section | Line | ~tokens |
|---|---|---|
| [0. The decisions, stated first](#0-the-decisions-stated-first) | 58 | 894 |
| [1. What this is answering, and what has already been ruled out](#1-what-this-is-answering-and-what-has-already-been-ruled-out) | 77 | 819 |
| [2. The representational commitment](#2-the-representational-commitment) | 142 | 1,104 |
| [3. Bodies: identification, ownership, tracking](#3-bodies-identification-ownership-tracking) | 233 | 2,353 |
| [4. Promotion criteria](#4-promotion-criteria) | 417 | 605 |
| [5. Demotion](#5-demotion) | 470 | 948 |
| [6. The seam — a body that is part CA and part heightfield](#6-the-seam--a-body-that-is-part-ca-and-part-heightfield) | 546 | 1,464 |
| [7. The pipe solver](#7-the-pipe-solver) | 665 | 1,991 |
| [8. Cross-chunk and the parallel sweep](#8-cross-chunk-and-the-parallel-sweep) | 847 | 1,094 |
| [9. One mechanism, shared with Report C's rigid bodies](#9-one-mechanism-shared-with-report-cs-rigid-bodies) | 936 | 1,114 |
| [10. Mass conservation, and the incompressibility lesson](#10-mass-conservation-and-the-incompressibility-lesson) | 1036 | 605 |
| [11. Build order — seam first, per Report B §5a](#11-build-order--seam-first-per-report-b-5a) | 1080 | 716 |
| [12. Acceptance criteria](#12-acceptance-criteria) | 1142 | 1,273 |
| [13. Deletion tests](#13-deletion-tests) | 1236 | 418 |
| [14. Explicitly out of scope](#14-explicitly-out-of-scope) | 1254 | 429 |
| [15. What was read, what was verified directly, and what was not](#15-what-was-read-what-was-verified-directly-and-what-was-not) | 1288 | 1,911 |
| [16. Handoff](#16-handoff) | 1422 | 328 |
