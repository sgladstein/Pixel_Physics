...
**Contents** — 13 sections, ~17,000 tokens. Read a section, not the file: the line number is there so you can `sed -n 'START,ENDp'` it, and the token column is there so that is a priced decision rather than a guess. Regenerated by `scripts/reporttoc.py`; a merge conflict inside this block is never hand-merged — take either side whole and re-run.

| Section | Line | ~tokens |
|---|---|---|
| [0. Where things stand](#0-where-things-stand) | 34 | 258 |
| [1. The unzip: the previous diagnosis was wrong](#1-the-unzip-the-previous-diagnosis-was-wrong) | 59 | 584 |
| [1b. The live bug: one dig erodes far more than it should](#1b-the-live-bug-one-dig-erodes-far-more-than-it-should) | 109 | 1,472 |
| [1a-NEW. FIXED: the gnome could not get into his own tunnel](#1a-new-fixed-the-gnome-could-not-get-into-his-own-tunnel) | 222 | 232 |
| [1a-NEW (original diagnosis). The gnome cannot get into his own tunnel](#1a-new-original-diagnosis-the-gnome-cannot-get-into-his-own-tunnel) | 243 | 1,143 |
| [1a-ii. Can a cave be dug and hold? Yes, and roof cover is what decides](#1a-ii-can-a-cave-be-dug-and-hold-yes-and-roof-cover-is-what-decides) | 341 | 2,305 |
| [1c. OPEN: a big strike unzips the surface sideways](#1c-open-a-big-strike-unzips-the-surface-sideways) | 525 | 2,585 |
| [1d. OWNERSHIP CHANGE: the gnome and creatures are now structural work](#1d-ownership-change-the-gnome-and-creatures-are-now-structural-work) | 725 | 1,399 |
| [2. What is still wrong](#2-what-is-still-wrong) | 832 | 3,277 |
| [3. What has been tried and must not be retried](#3-what-has-been-tried-and-must-not-be-retried) | 1079 | 1,388 |
| [4. The measurement loop](#4-the-measurement-loop) | 1170 | 1,079 |
| [5. After this](#5-after-this) | 1258 | 429 |
| [6. Repo gotchas these sessions paid for](#6-repo-gotchas-these-sessions-paid-for) | 1292 | 257 |
