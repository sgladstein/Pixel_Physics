...
## Lane 3 — nothing steers a laden ant home

**The owner's "nests never seemed to function" is right, and the measurement
picks his own second reading — the trail, not the nest.** Channel A stands at
**3,421 at frame 10,000 and 0–9 from 20,000 on**; cutting the homing circuit
out of the genome entirely leaves deliveries **inside the noise** between two
mechanically identical no-homing arms; **laden ants are 0–10% at the food**.
