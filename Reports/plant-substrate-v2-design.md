...
**Contents** — 11 sections, ~29,799 tokens. Read a section, not the file: the line number is there so you can `sed -n 'START,ENDp'` it, and the token column is there so that is a priced decision rather than a guess. Regenerated by `scripts/reporttoc.py`; a merge conflict inside this block is never hand-merged — take either side whole and re-run.

| Section | Line | ~tokens |
|---|---|---|
| [0. A sourcing correction, stated before anything that depends on it](#0-a-sourcing-correction-stated-before-anything-that-depends-on-it) | 43 | 525 |
| [1. The six decisions, stated first](#1-the-six-decisions-stated-first) | 80 | 1,106 |
| [2. Decision 1 — the growth-mode question](#2-decision-1--the-growth-mode-question) | 133 | 2,729 |
| [3. Decision 2 — `Cell::aux` → sidecar storage](#3-decision-2--cellaux--sidecar-storage) | 327 | 3,323 |
| [4. Decision 3 — soil moisture, grounded in real soil physics](#4-decision-3--soil-moisture-grounded-in-real-soil-physics) | 577 | 3,630 |
| [5. Decision 4 — real `Leaf` cells, seed reserve, leaf-gated photosynthesis](#5-decision-4--real-leaf-cells-seed-reserve-leaf-gated-photosynthesis) | 826 | 2,133 |
| [6. Decision 5 — differentiated materials, and environmental interaction](#6-decision-5--differentiated-materials-and-environmental-interaction) | 977 | 1,720 |
| [7. Decision 6 — polarity and directional resource flux](#7-decision-6--polarity-and-directional-resource-flux) | 1109 | 9,754 |
| [8. Deliberately out of scope](#8-deliberately-out-of-scope) | 1829 | 736 |
| [9. Simplifications, stated honestly](#9-simplifications-stated-honestly) | 1881 | 1,123 |
| [10. Retrofit order](#10-retrofit-order) | 1956 | 2,249 |
