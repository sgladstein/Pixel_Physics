...
**Contents** — 17 sections, ~23,691 tokens. Read a section, not the file: the line number is there so you can `sed -n 'START,ENDp'` it, and the token column is there so that is a priced decision rather than a guess. Regenerated by `scripts/reporttoc.py`; a merge conflict inside this block is never hand-merged — take either side whole and re-run.

| Section | Line | ~tokens |
|---|---|---|
| [1. What a blast in stone actually does today, measured](#1-what-a-blast-in-stone-actually-does-today-measured) | 49 | 1,013 |
| [2. Lens one: what really happens when a charge fires inside rock](#2-lens-one-what-really-happens-when-a-charge-fires-inside-rock) | 135 | 390 |
| [3. Lens three: what makes blasting fun, and where it agrees with lens one](#3-lens-three-what-makes-blasting-fun-and-where-it-agrees-with-lens-one) | 163 | 457 |
| [4. The intersection, and what to build](#4-the-intersection-and-what-to-build) | 194 | 1,795 |
| [5. What adversarial verification changed](#5-what-adversarial-verification-changed) | 323 | 941 |
| [6. The three pathologies — disposition](#6-the-three-pathologies--disposition) | 381 | 402 |
| [7. Implementation handoff — the prototype, written for a cold start](#7-implementation-handoff--the-prototype-written-for-a-cold-start) | 389 | 2,845 |
| [8. The prototype, built and measured](#8-the-prototype-built-and-measured) | 582 | 792 |
| [9. The believability pass — §8b's polish, done properly](#9-the-believability-pass--8bs-polish-done-properly) | 637 | 864 |
| [10. Fissures that grow — the stamp complaint](#10-fissures-that-grow--the-stamp-complaint) | 691 | 563 |
| [11. Round three — brittle cracks, calving pieces, an ember that cools](#11-round-three--brittle-cracks-calving-pieces-an-ember-that-cools) | 729 | 690 |
| [12. R3a — big collapses arrive in stages](#12-r3a--big-collapses-arrive-in-stages) | 774 | 484 |
| [13. R4 — powder weighs on the stone beneath it](#13-r4--powder-weighs-on-the-stone-beneath-it) | 805 | 2,394 |
| [14. The "pale light" report — it was not the explosion](#14-the-pale-light-report--it-was-not-the-explosion) | 980 | 910 |
| [15. The joint fabric — the pattern stops being drawn and starts being read](#15-the-joint-fabric--the-pattern-stops-being-drawn-and-starts-being-read) | 1042 | 1,362 |
| [16. The crush stops drawing a scribble over the fabric](#16-the-crush-stops-drawing-a-scribble-over-the-fabric) | 1141 | 2,016 |
| [17. The containment number was the gate restated](#17-the-containment-number-was-the-gate-restated) | 1309 | 4,823 |
