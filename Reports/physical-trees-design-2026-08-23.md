...
**Contents** — 12 sections, ~16,586 tokens. Read a section, not the file: the line number is there so you can `sed -n 'START,ENDp'` it, and the token column is there so that is a priced decision rather than a guess. Regenerated by `scripts/reporttoc.py`; a merge conflict inside this block is never hand-merged — take either side whole and re-run.

| Section | Line | ~tokens |
|---|---|---|
| [0. Summary, stated first](#0-summary-stated-first) | 49 | 883 |
| [1. What the owner is reacting to, measured](#1-what-the-owner-is-reacting-to-measured) | 110 | 333 |
| [2. The constraints, hoisted to the front because they kill options](#2-the-constraints-hoisted-to-the-front-because-they-kill-options) | 141 | 600 |
| [3. SWAY](#3-sway) | 187 | 1,878 |
| [4. IMPACT BREAKAGE](#4-impact-breakage) | 331 | 1,073 |
| [5. THE FRAGMENT LADDER, and the prototype that settles it](#5-the-fragment-ladder-and-the-prototype-that-settles-it) | 413 | 1,925 |
| [6. FELLING AND TOPPLE — the "partially rigid" core](#6-felling-and-topple--the-partially-rigid-core) | 563 | 1,705 |
| [7. What we are NOT doing, and why](#7-what-we-are-not-doing-and-why) | 684 | 526 |
| [8. The staged path](#8-the-staged-path) | 720 | 1,024 |
| [9. Findings filed rather than fixed](#9-findings-filed-rather-than-fixed) | 793 | 455 |
| [10. Freshness](#10-freshness) | 826 | 313 |
| [11. Addendum, 2026-08-23 — wind-throw: roots as anchorage, slenderness as the second failure mode](#11-addendum-2026-08-23--wind-throw-roots-as-anchorage-slenderness-as-the-second-failure-mode) | 850 | 5,104 |
