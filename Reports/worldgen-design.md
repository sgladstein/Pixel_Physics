...
**Contents** — 14 sections, ~13,038 tokens. Read a section, not the file: the line number is there so you can `sed -n 'START,ENDp'` it, and the token column is there so that is a priced decision rather than a guess. Regenerated by `scripts/reporttoc.py`; a merge conflict inside this block is never hand-merged — take either side whole and re-run.

| Section | Line | ~tokens |
|---|---|---|
| [0. Dimensionality: 2D side-view play, 3D worldgen **[new]**](#0-dimensionality-2d-side-view-play-3d-worldgen-new) | 51 | 2,390 |
| [1. The principle: worldgen is initial conditions for channels](#1-the-principle-worldgen-is-initial-conditions-for-channels) | 140 | 213 |
| [2. Vertical structure](#2-vertical-structure) | 151 | 522 |
| [3. How zone boundaries are defined](#3-how-zone-boundaries-are-defined) | 186 | 380 |
| [4. `worldgen(seed, coord, world_age)`](#4-worldgenseed-coord-worldage) | 205 | 301 |
| [5. The layered architecture is forced](#5-the-layered-architecture-is-forced) | 222 | 2,121 |
| [6. Two hard constraints that will bite](#6-two-hard-constraints-that-will-bite) | 298 | 686 |
| [7. Caves](#7-caves) | 328 | 2,449 |
| [8. Channel persistence: derived vs accumulated](#8-channel-persistence-derived-vs-accumulated) | 403 | 299 |
| [9. Do not hardcode the depth split](#9-do-not-hardcode-the-depth-split) | 423 | 361 |
| [10. The parameters-as-data gap](#10-the-parameters-as-data-gap) | 439 | 676 |
| [11. Suggested sequencing](#11-suggested-sequencing) | 481 | 402 |
| [12. Sources consulted](#12-sources-consulted) | 496 | 439 |
| [13. Open questions](#13-open-questions) | 511 | 494 |
