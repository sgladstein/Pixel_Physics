...
| `PageUp` / `PageDown` | Switch which tunables menu is shown (PHYSICS / VISUAL / EXPLOSION / PLAYER / WORLD), while the panel is open. Split because a dozen materials times ten fields is one scroll of well over a hundred rows. |
