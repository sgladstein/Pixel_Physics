...
| [Lab soil status — a hole that stays a hole, and a bed that stops running out](#lab-soil-status--a-hole-that-stays-a-hole-and-a-bed-that-stops-running-out) | 6579 |
...
| **powders and granular flow** | engine | [Materials](#materials) 259, [Architecture](#architecture) 333, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-and-a-bed-that-stops-running-out) 6579 |
...
| **the evolution lab — the box and its lights** | lab | [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 4914, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-and-a-bed-that-stops-running-out) 6579 |
