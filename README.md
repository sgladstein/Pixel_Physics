...
Generated by `scripts/readmetoc.py` from the `##` headings — 73 of
...
|---|---|
| [Running](#running) | 173 |
| [Finding things](#finding-things) | 189 |
| [Controls](#controls) | 225 |
| [Materials](#materials) | 296 |
| [Architecture](#architecture) | 370 |
| [The coarse field grid](#the-coarse-field-grid) | 572 |
| [M12/M13 status](#m12m13-status) | 834 |
| [Canopy throughfall status — rain drips through a wood](#canopy-throughfall-status--rain-drips-through-a-wood) | 861 |
| [Liquid physics: compressible volume, not discrete occupied cells](#liquid-physics-compressible-volume-not-discrete-occupied-cells) | 990 |
| [M14 status](#m14-status) | 1016 |
| [M7 status](#m7-status) | 1164 |
| [M15 status](#m15-status) | 1193 |
| [M6 deferral](#m6-deferral) | 1324 |
| [M5 status](#m5-status) | 1334 |
| [Plant lines merged: the genome, and the ecology](#plant-lines-merged-the-genome-and-the-ecology) | 1429 |
| [The generation loop: plants die, seeds expire, slots come back](#the-generation-loop-plants-die-seeds-expire-slots-come-back) | 1499 |
| [The economy re-derived: standing tissue costs something](#the-economy-re-derived-standing-tissue-costs-something) | 1580 |
| [Stems draw a line: the growth walk renders its heading](#stems-draw-a-line-the-growth-walk-renders-its-heading) | 1788 |
| [Plants that stop: organs, determinacy, and a price on both](#plants-that-stop-organs-determinacy-and-a-price-on-both) | 1870 |
| [M16 status](#m16-status) | 1938 |
| [M17 status](#m17-status) | 2124 |
| [M18 status](#m18-status) | 2351 |
| [UI improvements — overnight run, section 9](#ui-improvements--overnight-run-section-9) | 2758 |
| [Live tunables panel — overnight run, section 10](#live-tunables-panel--overnight-run-section-10) | 2803 |
| [Rendering performance — overnight run, section 11](#rendering-performance--overnight-run-section-11) | 2871 |
| [Zoom-out resolution status — more pixels instead of fewer cells](#zoom-out-resolution-status--more-pixels-instead-of-fewer-cells) | 2891 |
| [Zoom-in styles status — what a cell's 64 pixels can say](#zoom-in-styles-status--what-a-cells-64-pixels-can-say) | 3060 |
| [M8 status — started, not complete](#m8-status--started-not-complete) | 3119 |
| [M9 status — the gnome](#m9-status--the-gnome) | 3232 |
| [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3738 |
| [Weather status](#weather-status) | 3908 |
| [The ant colony — status](#the-ant-colony--status) | 3925 |
| [Inheritance status — the growth program has no fallback under it](#inheritance-status--the-growth-program-has-no-fallback-under-it) | 4717 |
| [Parameter-genome status — a species file is a starting point, and it ships inert](#parameter-genome-status--a-species-file-is-a-starting-point-and-it-ships-inert) | 4820 |
| [M19 status — started](#m19-status--started) | 4928 |
| [Felling status — the verb works, and what it produces is pieces](#felling-status--the-verb-works-and-what-it-produces-is-pieces) | 5000 |
| [Bending status — soft tissue lies over, and the wind is what pushes it](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) | 5237 |
| [Breaking status — a badly grown tree comes down on its own](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) | 5314 |
| [Lab lighting status — the fixtures are what light the crop](#lab-lighting-status--the-fixtures-are-what-light-the-crop) | 5507 |
| [Cell page status — the specimen readout is in three groups, and folds](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) | 5634 |
| [Roster status — every plant and every animal, as a list you click through](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) | 5682 |
| [Plain-speech status — the genome read back as sentences](#plain-speech-status--the-genome-read-back-as-sentences) | 5913 |
| [Watch status — where one individual has been, and how its numbers moved](#watch-status--where-one-individual-has-been-and-how-its-numbers-moved) | 6038 |
| [Side-by-side status — two individuals, with what differs marked](#side-by-side-status--two-individuals-with-what-differs-marked) | 6103 |
| [Lineage overlay status — which founding line is taking the bed](#lineage-overlay-status--which-founding-line-is-taking-the-bed) | 6165 |
| [Creature groups status — who is who in the box, and who is family](#creature-groups-status--who-is-who-in-the-box-and-who-is-family) | 6245 |
| [Life record status — what an individual has done, and what killed it](#life-record-status--what-an-individual-has-done-and-what-killed-it) | 6667 |
| [Specimen shelf status — an individual's genetics outlive the box](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) | 6775 |
| [Lab hand-verbs status — what a click puts in the box, and what the view shows](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) | 6837 |
| [Lab parameters status — a save that reaches the founders, not just the file](#lab-parameters-status--a-save-that-reaches-the-founders-not-just-the-file) | 6925 |
| [Performance](#performance) | 6975 |
| [World speed — five independent time axes](#world-speed--five-independent-time-axes) | 7172 |
| [Status](#status) | 7255 |
| [License](#license) | 7366 |
| [Lab speed-dial status — what the dial is actually short of](#lab-speed-dial-status--what-the-dial-is-actually-short-of) | 7390 |
| [Lab scenarios status — a saved starting box with a question written on it](#lab-scenarios-status--a-saved-starting-box-with-a-question-written-on-it) | 7547 |
| [Soil nutrient status — ground is worth something water is not](#soil-nutrient-status--ground-is-worth-something-water-is-not) | 7650 |
| [Lab soil status — a hole that stays a hole anywhere in the bed, and a bed that stops running out](#lab-soil-status--a-hole-that-stays-a-hole-anywhere-in-the-bed-and-a-bed-that-stops-running-out) | 7693 |
| [Chronicle status — the box tells you who did what, at any population](#chronicle-status--the-box-tells-you-who-did-what-at-any-population) | 7850 |
| [Event reaction status — the box calls you back](#event-reaction-status--the-box-calls-you-back) | 7918 |
| [Life marks status — a pause-time mark, and what the owner rejected](#life-marks-status--a-pause-time-mark-and-what-the-owner-rejected) | 7958 |
| [Hunger status — a fed ant rests, a hungry one walks, and the founding cliff is walking cost](#hunger-status--a-fed-ant-rests-a-hungry-one-walks-and-the-founding-cliff-is-walking-cost) | 7993 |
| [Hopper status — the jump has a species, and it hops itself to death](#hopper-status--the-jump-has-a-species-and-it-hops-itself-to-death) | 8073 |
| [Rest status — a rest that ends, so a resting animal is not a stopped one](#rest-status--a-rest-that-ends-so-a-resting-animal-is-not-a-stopped-one) | 8104 |
| [Creature tools status — a hand in the box: scent, alarm, fling, lamp](#creature-tools-status--a-hand-in-the-box-scent-alarm-fling-lamp) | 8178 |
| [Trophallaxis status — the colony's stomach, shipped on, and a first measurement that says wait](#trophallaxis-status--the-colonys-stomach-shipped-on-and-a-first-measurement-that-says-wait) | 8235 |
...
| [Lifespan status — an ant gets old, and the colony's fall becomes a slope](#lifespan-status--an-ant-gets-old-and-the-colonys-fall-becomes-a-slope) | 8384 |
| [Held world status — the third game, and time you carry in a circle](#held-world-status--the-third-game-and-time-you-carry-in-a-circle) | 8530 |
| [Colony books status — what each colony is living on, in joules](#colony-books-status--what-each-colony-is-living-on-in-joules) | 9438 |
| [Food road status — the trail the colony actually walks, and the box that was not there](#food-road-status--the-trail-the-colony-actually-walks-and-the-box-that-was-not-there) | 9569 |
| [Field wake status — the field solves for the ants, and only one half of the fix is free](#field-wake-status--the-field-solves-for-the-ants-and-only-one-half-of-the-fix-is-free) | 9624 |
...
| M | Section | Line |
|---|---|---|
| 5 | [M5 status](#m5-status) | 1334 |
| 6 | [M6 deferral](#m6-deferral) | 1324 |
| 7 | [M7 status](#m7-status) | 1164 |
| 8 | [M8 status — started, not complete](#m8-status--started-not-complete) | 3119 |
| 9 | [M9 status — the gnome](#m9-status--the-gnome) | 3232 |
| 10 | [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3738 |
| 12 | [M12/M13 status](#m12m13-status) | 834 |
| 14 | [M14 status](#m14-status) | 1016 |
| 15 | [M15 status](#m15-status) | 1193 |
| 16 | [M16 status](#m16-status) | 1938 |
| 17 | [M17 status](#m17-status) | 2124 |
| 18 | [M18 status](#m18-status) | 2351 |
| 19 | [M19 status — started](#m19-status--started) | 4928 |
...
[Status](#status), line 7255 — the *last* section in the
...
| **liquids and gases** | engine | [Liquid physics](#liquid-physics-compressible-volume-not-discrete-occupied-cells) 990, [Canopy throughfall status](#canopy-throughfall-status--rain-drips-through-a-wood) 861, [The coarse field grid](#the-coarse-field-grid) 572 |
| **powders and granular flow** | engine | [Materials](#materials) 296, [Architecture](#architecture) 370, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-anywhere-in-the-bed-and-a-bed-that-stops-running-out) 7693 |
| **the coarse field grid — pressure, heat, light** | engine | [The coarse field grid](#the-coarse-field-grid) 572, [M12/M13 status](#m12m13-status) 834, [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 5507, [Field wake status](#field-wake-status--the-field-solves-for-the-ants-and-only-one-half-of-the-fix-is-free) 9624 |
| **worldgen and world structure** | outdoor | [M10 status](#m10-status--the-worldgen-half) 3738, [Architecture](#architecture) 370 |
| **the gnome (player character)** | outdoor | [M9 status](#m9-status--the-gnome) 3232, [Controls](#controls) 225 |
| **weather, sky and the clock** | engine | [Weather status](#weather-status) 3908, [M19 status](#m19-status--started) 4928, [World speed](#world-speed--five-independent-time-axes) 7172 |
| **rendering, UI and tunables** | engine | [Zoom-out resolution status](#zoom-out-resolution-status--more-pixels-instead-of-fewer-cells) 2891, [Zoom-in styles status](#zoom-in-styles-status--what-a-cells-64-pixels-can-say) 3060, [UI improvements](#ui-improvements--overnight-run-section-9) 2758, [Live tunables panel](#live-tunables-panel--overnight-run-section-10) 2803, [Rendering performance](#rendering-performance--overnight-run-section-11) 2871, [M6 deferral](#m6-deferral) 1324 |
| **performance and the parallel sweep** | engine | [Performance](#performance) 6975, [M5 status](#m5-status) 1334, [Architecture](#architecture) 370, [Rendering performance](#rendering-performance--overnight-run-section-11) 2871, [Lab speed-dial status](#lab-speed-dial-status--what-the-dial-is-actually-short-of) 7390 |
| **materials and the data schema** | engine | [Materials](#materials) 296, [M12/M13 status](#m12m13-status) 834 |
| **the evolution lab — the box and its lights** | lab | [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 5507, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-anywhere-in-the-bed-and-a-bed-that-stops-running-out) 7693 |
| **reading one specimen off the screen** | lab | [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 5634 |
| **keeping, cloning and mutating an individual** | lab | [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 6775 |
| **finding one individual among all of them** | lab | [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 5682 |
| **the genome in plain words** | lab | [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 5913 |
| **what an individual has done, and what killed it** | lab | [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 6667 |
| **watching one individual over time** | lab | [Watch status](#watch-status--where-one-individual-has-been-and-how-its-numbers-moved) 6038 |
| **comparing two individuals** | lab | [Side-by-side status](#side-by-side-status--two-individuals-with-what-differs-marked) 6103 |
| **which founding line is winning** | lab | [Lineage overlay status](#lineage-overlay-status--which-founding-line-is-taking-the-bed) 6165 |
| **who is who in the box, colonies and the rivalry rule** | lab | [Creature groups status](#creature-groups-status--who-is-who-in-the-box-and-who-is-family) 6245 |
| **putting things in the box, and what the view shows** | lab | [Lab hand-verbs status](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) 6837 |
| **the chronicle: names, line events, and a clock that reacts** | lab | [Chronicle status](#chronicle-status--the-box-tells-you-who-did-what-at-any-population) 7850, [Event reaction status](#event-reaction-status--the-box-calls-you-back) 7918, [Life marks status](#life-marks-status--a-pause-time-mark-and-what-the-owner-rejected) 7958 |
| **a hand in the box: scent, alarm, fling, lamp** | lab | [Creature tools status](#creature-tools-status--a-hand-in-the-box-scent-alarm-fling-lamp) 8178 |
...
| **the held world — the third game, and time you carry** | held | [Held world status](#held-world-status--the-third-game-and-time-you-carry-in-a-circle) 8530 |
