...
| [Zoom-in styles status — what a cell's 64 pixels can say](#zoom-in-styles-status--what-a-cells-64-pixels-can-say) | 2889 |
| [M8 status — started, not complete](#m8-status--started-not-complete) | 2948 |
| [M9 status — the gnome](#m9-status--the-gnome) | 3061 |
| [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3501 |
| [Weather status](#weather-status) | 3671 |
| [The ant colony — status](#the-ant-colony--status) | 3688 |
| [Inheritance status — the growth program has no fallback under it](#inheritance-status--the-growth-program-has-no-fallback-under-it) | 4480 |
| [Parameter-genome status — a species file is a starting point, and it ships inert](#parameter-genome-status--a-species-file-is-a-starting-point-and-it-ships-inert) | 4583 |
| [M19 status — started](#m19-status--started) | 4691 |
| [Felling status — the verb works, and what it produces is pieces](#felling-status--the-verb-works-and-what-it-produces-is-pieces) | 4763 |
| [Bending status — soft tissue lies over, and the wind is what pushes it](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) | 5000 |
| [Breaking status — a badly grown tree comes down on its own](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) | 5077 |
| [Lab lighting status — the fixtures are what light the crop](#lab-lighting-status--the-fixtures-are-what-light-the-crop) | 5270 |
| [Cell page status — the specimen readout is in three groups, and folds](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) | 5397 |
| [Roster status — every plant and every animal, as a list you click through](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) | 5445 |
| [Plain-speech status — the genome read back as sentences](#plain-speech-status--the-genome-read-back-as-sentences) | 5676 |
| [Watch status — where one individual has been, and how its numbers moved](#watch-status--where-one-individual-has-been-and-how-its-numbers-moved) | 5801 |
| [Side-by-side status — two individuals, with what differs marked](#side-by-side-status--two-individuals-with-what-differs-marked) | 5866 |
| [Lineage overlay status — which founding line is taking the bed](#lineage-overlay-status--which-founding-line-is-taking-the-bed) | 5928 |
| [Creature groups status — who is who in the box, and who is family](#creature-groups-status--who-is-who-in-the-box-and-who-is-family) | 6008 |
| [Life record status — what an individual has done, and what killed it](#life-record-status--what-an-individual-has-done-and-what-killed-it) | 6430 |
| [Specimen shelf status — an individual's genetics outlive the box](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) | 6538 |
| [Lab hand-verbs status — what a click puts in the box, and what the view shows](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) | 6600 |
| [Lab parameters status — a save that reaches the founders, not just the file](#lab-parameters-status--a-save-that-reaches-the-founders-not-just-the-file) | 6688 |
| [Performance](#performance) | 6738 |
| [World speed — five independent time axes](#world-speed--five-independent-time-axes) | 6935 |
| [Status](#status) | 7018 |
| [License](#license) | 7129 |
| [Lab speed-dial status — what the dial is actually short of](#lab-speed-dial-status--what-the-dial-is-actually-short-of) | 7153 |
| [Lab scenarios status — a saved starting box with a question written on it](#lab-scenarios-status--a-saved-starting-box-with-a-question-written-on-it) | 7310 |
| [Soil nutrient status — ground is worth something water is not](#soil-nutrient-status--ground-is-worth-something-water-is-not) | 7396 |
| [Lab soil status — a hole that stays a hole anywhere in the bed, and a bed that stops running out](#lab-soil-status--a-hole-that-stays-a-hole-anywhere-in-the-bed-and-a-bed-that-stops-running-out) | 7439 |
| [Chronicle status — the box tells you who did what, at any population](#chronicle-status--the-box-tells-you-who-did-what-at-any-population) | 7596 |
| [Event reaction status — the box calls you back](#event-reaction-status--the-box-calls-you-back) | 7664 |
| [Life marks status — a pause-time mark, and what the owner rejected](#life-marks-status--a-pause-time-mark-and-what-the-owner-rejected) | 7704 |
| [Hunger status — a fed ant rests, a hungry one walks, and the founding cliff is walking cost](#hunger-status--a-fed-ant-rests-a-hungry-one-walks-and-the-founding-cliff-is-walking-cost) | 7739 |
| [Hopper status — the jump has a species, and it hops itself to death](#hopper-status--the-jump-has-a-species-and-it-hops-itself-to-death) | 7819 |
| [Creature tools status — a hand in the box: scent, alarm, fling, lamp](#creature-tools-status--a-hand-in-the-box-scent-alarm-fling-lamp) | 7850 |
| [Trophallaxis status — the colony's stomach, shipped on, and a first measurement that says wait](#trophallaxis-status--the-colonys-stomach-shipped-on-and-a-first-measurement-that-says-wait) | 7907 |
| [Trail status — the ant reads its way home, and the food trail is the larder's problem](#trail-status--the-ant-reads-its-way-home-and-the-food-trail-is-the-larders-problem) | 7965 |
| [Lifespan status — an ant gets old, and the colony's fall becomes a slope](#lifespan-status--an-ant-gets-old-and-the-colonys-fall-becomes-a-slope) | 8002 |
...
| 8 | [M8 status — started, not complete](#m8-status--started-not-complete) | 2948 |
| 9 | [M9 status — the gnome](#m9-status--the-gnome) | 3061 |
| 10 | [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3501 |
...
| 19 | [M19 status — started](#m19-status--started) | 4691 |
...
[Status](#status), line 7018 — the *last* section in the
...
|---|---|---|
| **plants, trees and moss** | engine | [M16 status](#m16-status) 1879, [Soil nutrient status](#soil-nutrient-status--ground-is-worth-something-water-is-not) 7396, [Plant lines merged](#plant-lines-merged-the-genome-and-the-ecology) 1399, [Inheritance status](#inheritance-status--the-growth-program-has-no-fallback-under-it) 4480, [Parameter-genome status](#parameter-genome-status--a-species-file-is-a-starting-point-and-it-ships-inert) 4583, [The economy re-derived](#the-economy-re-derived-standing-tissue-costs-something) 1521, [Plants that stop](#plants-that-stop-organs-determinacy-and-a-price-on-both) 1811, [The generation loop](#the-generation-loop-plants-die-seeds-expire-slots-come-back) 1469, [Stems draw a line](#stems-draw-a-line-the-growth-walk-renders-its-heading) 1729, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 4763, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 5000, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 5077, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 6538, [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 5397, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 5445, [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 5676, [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 6430 |
| **creatures — worms and the ant colony** | engine | [M18 status](#m18-status) 2292, [The ant colony](#the-ant-colony--status) 3688, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 6538, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 5445, [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 5676, [Lab hand-verbs status](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) 6600, [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 6430, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-anywhere-in-the-bed-and-a-bed-that-stops-running-out) 7439, [Hunger status](#hunger-status--a-fed-ant-rests-a-hungry-one-walks-and-the-founding-cliff-is-walking-cost) 7739, [Hopper status](#hopper-status--the-jump-has-a-species-and-it-hops-itself-to-death) 7819, [Trophallaxis status](#trophallaxis-status--the-colonys-stomach-shipped-on-and-a-first-measurement-that-says-wait) 7907, [Trail status](#trail-status--the-ant-reads-its-way-home-and-the-food-trail-is-the-larders-problem) 7965, [Lifespan status](#lifespan-status--an-ant-gets-old-and-the-colonys-fall-becomes-a-slope) 8002 |
| **structural collapse, felling and rigid bodies** | outdoor | [M17 status](#m17-status) 2065, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 4763, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 5000, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 5077, [M8 status](#m8-status--started-not-complete) 2948 |
...
| **powders and granular flow** | engine | [Materials](#materials) 281, [Architecture](#architecture) 355, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-anywhere-in-the-bed-and-a-bed-that-stops-running-out) 7439 |
| **the coarse field grid — pressure, heat, light** | engine | [The coarse field grid](#the-coarse-field-grid) 542, [M12/M13 status](#m12m13-status) 804, [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 5270 |
| **worldgen and world structure** | outdoor | [M10 status](#m10-status--the-worldgen-half) 3501, [Architecture](#architecture) 355 |
| **the gnome (player character)** | outdoor | [M9 status](#m9-status--the-gnome) 3061, [Controls](#controls) 210 |
| **weather, sky and the clock** | engine | [Weather status](#weather-status) 3671, [M19 status](#m19-status--started) 4691, [World speed](#world-speed--five-independent-time-axes) 6935 |
| **rendering, UI and tunables** | engine | [Zoom-out resolution status](#zoom-out-resolution-status--more-pixels-instead-of-fewer-cells) 2832, [Zoom-in styles status](#zoom-in-styles-status--what-a-cells-64-pixels-can-say) 2889, [UI improvements](#ui-improvements--overnight-run-section-9) 2699, [Live tunables panel](#live-tunables-panel--overnight-run-section-10) 2744, [Rendering performance](#rendering-performance--overnight-run-section-11) 2812, [M6 deferral](#m6-deferral) 1294 |
| **performance and the parallel sweep** | engine | [Performance](#performance) 6738, [M5 status](#m5-status) 1304, [Architecture](#architecture) 355, [Rendering performance](#rendering-performance--overnight-run-section-11) 2812, [Lab speed-dial status](#lab-speed-dial-status--what-the-dial-is-actually-short-of) 7153 |
| **materials and the data schema** | engine | [Materials](#materials) 281, [M12/M13 status](#m12m13-status) 804 |
| **the evolution lab — the box and its lights** | lab | [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 5270, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-anywhere-in-the-bed-and-a-bed-that-stops-running-out) 7439 |
| **reading one specimen off the screen** | lab | [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 5397 |
| **keeping, cloning and mutating an individual** | lab | [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 6538 |
| **finding one individual among all of them** | lab | [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 5445 |
| **the genome in plain words** | lab | [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 5676 |
| **what an individual has done, and what killed it** | lab | [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 6430 |
| **watching one individual over time** | lab | [Watch status](#watch-status--where-one-individual-has-been-and-how-its-numbers-moved) 5801 |
| **comparing two individuals** | lab | [Side-by-side status](#side-by-side-status--two-individuals-with-what-differs-marked) 5866 |
| **which founding line is winning** | lab | [Lineage overlay status](#lineage-overlay-status--which-founding-line-is-taking-the-bed) 5928 |
| **who is who in the box, colonies and the rivalry rule** | lab | [Creature groups status](#creature-groups-status--who-is-who-in-the-box-and-who-is-family) 6008 |
| **putting things in the box, and what the view shows** | lab | [Lab hand-verbs status](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) 6600 |
| **the chronicle: names, line events, and a clock that reacts** | lab | [Chronicle status](#chronicle-status--the-box-tells-you-who-did-what-at-any-population) 7596, [Event reaction status](#event-reaction-status--the-box-calls-you-back) 7664, [Life marks status](#life-marks-status--a-pause-time-mark-and-what-the-owner-rejected) 7704 |
| **a hand in the box: scent, alarm, fling, lamp** | lab | [Creature tools status](#creature-tools-status--a-hand-in-the-box-scent-alarm-fling-lamp) 7850 |
| **the speed dial, and what a tick costs** | lab | [Lab speed-dial status](#lab-speed-dial-status--what-the-dial-is-actually-short-of) 7153 |
| **tuning and saving the box's own numbers** | lab | [Lab parameters status](#lab-parameters-status--a-save-that-reaches-the-founders-not-just-the-file) 6688 |
| **a saved starting box, and replicating it in a rack** | lab | [Lab scenarios status](#lab-scenarios-status--a-saved-starting-box-with-a-question-written-on-it) 7310 |
...
| `+` (shift `=`), zoomed **out** | **How many of the cells in view get a pixel of their own** — cycles `App::pixel_budget` x1 / x2 / x4. At the widest zoom-out the view spans 2048x1280 cells through a 512x320 back-buffer, so 94% of them cannot reach a pixel at all and `ZoomOutFilter` above only decides which of each sixteen wins. This grows the buffer instead — x4 carries every cell at one pixel each — bounded by what the window can actually display, because pixels past that are paid for and then discarded by the GPU. **x1 is the default and is bit-identical to every build before 2026-09-13.** Priced at 1.31-1.37x the whole frame for x2 and 1.79-2.07x for x4 (`Reports/zoom-out-resolution-2026-09-13.md`). Same key as the zoom-in styles below because the two are never live at once |
