...
Generated by `scripts/readmetoc.py` from the `##` headings — 66 of
...
|---|---|
| [Running](#running) | 165 |
| [Finding things](#finding-things) | 173 |
| [Controls](#controls) | 209 |
| [Materials](#materials) | 279 |
| [Architecture](#architecture) | 353 |
| [The coarse field grid](#the-coarse-field-grid) | 540 |
| [M12/M13 status](#m12m13-status) | 802 |
| [Canopy throughfall status — rain drips through a wood](#canopy-throughfall-status--rain-drips-through-a-wood) | 829 |
| [Liquid physics: compressible volume, not discrete occupied cells](#liquid-physics-compressible-volume-not-discrete-occupied-cells) | 958 |
| [M14 status](#m14-status) | 984 |
| [M7 status](#m7-status) | 1132 |
| [M15 status](#m15-status) | 1161 |
| [M6 deferral](#m6-deferral) | 1292 |
| [M5 status](#m5-status) | 1302 |
| [Plant lines merged: the genome, and the ecology](#plant-lines-merged-the-genome-and-the-ecology) | 1397 |
| [The generation loop: plants die, seeds expire, slots come back](#the-generation-loop-plants-die-seeds-expire-slots-come-back) | 1467 |
| [The economy re-derived: standing tissue costs something](#the-economy-re-derived-standing-tissue-costs-something) | 1519 |
| [Stems draw a line: the growth walk renders its heading](#stems-draw-a-line-the-growth-walk-renders-its-heading) | 1727 |
| [Plants that stop: organs, determinacy, and a price on both](#plants-that-stop-organs-determinacy-and-a-price-on-both) | 1809 |
| [M16 status](#m16-status) | 1877 |
| [M17 status](#m17-status) | 2063 |
| [M18 status](#m18-status) | 2290 |
| [UI improvements — overnight run, section 9](#ui-improvements--overnight-run-section-9) | 2697 |
| [Live tunables panel — overnight run, section 10](#live-tunables-panel--overnight-run-section-10) | 2742 |
| [Rendering performance — overnight run, section 11](#rendering-performance--overnight-run-section-11) | 2810 |
| [Zoom-in styles status — what a cell's 64 pixels can say](#zoom-in-styles-status--what-a-cells-64-pixels-can-say) | 2830 |
| [M8 status — started, not complete](#m8-status--started-not-complete) | 2889 |
| [M9 status — the gnome](#m9-status--the-gnome) | 3002 |
| [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3442 |
| [Weather status](#weather-status) | 3612 |
| [The ant colony — status](#the-ant-colony--status) | 3629 |
| [Inheritance status — the growth program has no fallback under it](#inheritance-status--the-growth-program-has-no-fallback-under-it) | 4421 |
| [Parameter-genome status — a species file is a starting point, and it ships inert](#parameter-genome-status--a-species-file-is-a-starting-point-and-it-ships-inert) | 4524 |
| [M19 status — started](#m19-status--started) | 4632 |
| [Felling status — the verb works, and what it produces is pieces](#felling-status--the-verb-works-and-what-it-produces-is-pieces) | 4704 |
| [Bending status — soft tissue lies over, and the wind is what pushes it](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) | 4941 |
| [Breaking status — a badly grown tree comes down on its own](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) | 5018 |
| [Lab lighting status — the fixtures are what light the crop](#lab-lighting-status--the-fixtures-are-what-light-the-crop) | 5211 |
| [Cell page status — the specimen readout is in three groups, and folds](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) | 5338 |
| [Roster status — every plant and every animal, as a list you click through](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) | 5386 |
| [Plain-speech status — the genome read back as sentences](#plain-speech-status--the-genome-read-back-as-sentences) | 5617 |
| [Watch status — where one individual has been, and how its numbers moved](#watch-status--where-one-individual-has-been-and-how-its-numbers-moved) | 5742 |
| [Side-by-side status — two individuals, with what differs marked](#side-by-side-status--two-individuals-with-what-differs-marked) | 5807 |
| [Lineage overlay status — which founding line is taking the bed](#lineage-overlay-status--which-founding-line-is-taking-the-bed) | 5869 |
| [Creature groups status — who is who in the box, and who is family](#creature-groups-status--who-is-who-in-the-box-and-who-is-family) | 5949 |
| [Life record status — what an individual has done, and what killed it](#life-record-status--what-an-individual-has-done-and-what-killed-it) | 6371 |
| [Specimen shelf status — an individual's genetics outlive the box](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) | 6479 |
| [Lab hand-verbs status — what a click puts in the box, and what the view shows](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) | 6541 |
| [Lab parameters status — a save that reaches the founders, not just the file](#lab-parameters-status--a-save-that-reaches-the-founders-not-just-the-file) | 6629 |
| [Performance](#performance) | 6679 |
| [World speed — five independent time axes](#world-speed--five-independent-time-axes) | 6876 |
| [Status](#status) | 6959 |
| [License](#license) | 7075 |
| [Lab speed-dial status — what the dial is actually short of](#lab-speed-dial-status--what-the-dial-is-actually-short-of) | 7099 |
| [Lab scenarios status — a saved starting box with a question written on it](#lab-scenarios-status--a-saved-starting-box-with-a-question-written-on-it) | 7256 |
| [Soil nutrient status — ground is worth something water is not](#soil-nutrient-status--ground-is-worth-something-water-is-not) | 7342 |
| [Lab soil status — a hole that stays a hole anywhere in the bed, and a bed that stops running out](#lab-soil-status--a-hole-that-stays-a-hole-anywhere-in-the-bed-and-a-bed-that-stops-running-out) | 7385 |
| [Chronicle status — the box tells you who did what, at any population](#chronicle-status--the-box-tells-you-who-did-what-at-any-population) | 7542 |
| [Event reaction status — the box calls you back](#event-reaction-status--the-box-calls-you-back) | 7610 |
| [Life marks status — a pause-time mark, and what the owner rejected](#life-marks-status--a-pause-time-mark-and-what-the-owner-rejected) | 7650 |
| [Hunger status — a fed ant rests, a hungry one walks, and the founding cliff is walking cost](#hunger-status--a-fed-ant-rests-a-hungry-one-walks-and-the-founding-cliff-is-walking-cost) | 7685 |
| [Hopper status — the jump has a species, and it hops itself to death](#hopper-status--the-jump-has-a-species-and-it-hops-itself-to-death) | 7765 |
| [Creature tools status — a hand in the box: scent, alarm, fling, lamp](#creature-tools-status--a-hand-in-the-box-scent-alarm-fling-lamp) | 7796 |
| [Trophallaxis status — the colony's stomach, shipped on, and a first measurement that says wait](#trophallaxis-status--the-colonys-stomach-shipped-on-and-a-first-measurement-that-says-wait) | 7853 |
| [Trail status — the ant reads its way home, and the food trail is the larder's problem](#trail-status--the-ant-reads-its-way-home-and-the-food-trail-is-the-larders-problem) | 7911 |
| [Lifespan status — an ant gets old, and the colony's fall becomes a slope](#lifespan-status--an-ant-gets-old-and-the-colonys-fall-becomes-a-slope) | 7948 |
...
| M | Section | Line |
|---|---|---|
| 5 | [M5 status](#m5-status) | 1302 |
| 6 | [M6 deferral](#m6-deferral) | 1292 |
| 7 | [M7 status](#m7-status) | 1132 |
| 8 | [M8 status — started, not complete](#m8-status--started-not-complete) | 2889 |
| 9 | [M9 status — the gnome](#m9-status--the-gnome) | 3002 |
| 10 | [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3442 |
| 12 | [M12/M13 status](#m12m13-status) | 802 |
| 14 | [M14 status](#m14-status) | 984 |
| 15 | [M15 status](#m15-status) | 1161 |
| 16 | [M16 status](#m16-status) | 1877 |
| 17 | [M17 status](#m17-status) | 2063 |
| 18 | [M18 status](#m18-status) | 2290 |
| 19 | [M19 status — started](#m19-status--started) | 4632 |
...
[Status](#status), line 6959 — the *last* section in the
...
|---|---|---|
| **plants, trees and moss** | engine | [M16 status](#m16-status) 1877, [Soil nutrient status](#soil-nutrient-status--ground-is-worth-something-water-is-not) 7342, [Plant lines merged](#plant-lines-merged-the-genome-and-the-ecology) 1397, [Inheritance status](#inheritance-status--the-growth-program-has-no-fallback-under-it) 4421, [Parameter-genome status](#parameter-genome-status--a-species-file-is-a-starting-point-and-it-ships-inert) 4524, [The economy re-derived](#the-economy-re-derived-standing-tissue-costs-something) 1519, [Plants that stop](#plants-that-stop-organs-determinacy-and-a-price-on-both) 1809, [The generation loop](#the-generation-loop-plants-die-seeds-expire-slots-come-back) 1467, [Stems draw a line](#stems-draw-a-line-the-growth-walk-renders-its-heading) 1727, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 4704, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 4941, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 5018, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 6479, [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 5338, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 5386, [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 5617, [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 6371 |
| **creatures — worms and the ant colony** | engine | [M18 status](#m18-status) 2290, [The ant colony](#the-ant-colony--status) 3629, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 6479, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 5386, [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 5617, [Lab hand-verbs status](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) 6541, [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 6371, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-anywhere-in-the-bed-and-a-bed-that-stops-running-out) 7385, [Hunger status](#hunger-status--a-fed-ant-rests-a-hungry-one-walks-and-the-founding-cliff-is-walking-cost) 7685, [Hopper status](#hopper-status--the-jump-has-a-species-and-it-hops-itself-to-death) 7765, [Trophallaxis status](#trophallaxis-status--the-colonys-stomach-shipped-on-and-a-first-measurement-that-says-wait) 7853, [Trail status](#trail-status--the-ant-reads-its-way-home-and-the-food-trail-is-the-larders-problem) 7911, [Lifespan status](#lifespan-status--an-ant-gets-old-and-the-colonys-fall-becomes-a-slope) 7948 |
| **structural collapse, felling and rigid bodies** | outdoor | [M17 status](#m17-status) 2063, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 4704, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 4941, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 5018, [M8 status](#m8-status--started-not-complete) 2889 |
| **fire, heat and phase change** | engine | [M14 status](#m14-status) 984, [Materials](#materials) 279 |
| **explosions, particles and debris** | outdoor | [M15 status](#m15-status) 1161, [M7 status](#m7-status) 1132 |
| **liquids and gases** | engine | [Liquid physics](#liquid-physics-compressible-volume-not-discrete-occupied-cells) 958, [Canopy throughfall status](#canopy-throughfall-status--rain-drips-through-a-wood) 829, [The coarse field grid](#the-coarse-field-grid) 540 |
| **powders and granular flow** | engine | [Materials](#materials) 279, [Architecture](#architecture) 353, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-anywhere-in-the-bed-and-a-bed-that-stops-running-out) 7385 |
| **the coarse field grid — pressure, heat, light** | engine | [The coarse field grid](#the-coarse-field-grid) 540, [M12/M13 status](#m12m13-status) 802, [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 5211 |
| **worldgen and world structure** | outdoor | [M10 status](#m10-status--the-worldgen-half) 3442, [Architecture](#architecture) 353 |
| **the gnome (player character)** | outdoor | [M9 status](#m9-status--the-gnome) 3002, [Controls](#controls) 209 |
| **weather, sky and the clock** | engine | [Weather status](#weather-status) 3612, [M19 status](#m19-status--started) 4632, [World speed](#world-speed--five-independent-time-axes) 6876 |
| **rendering, UI and tunables** | engine | [Zoom-in styles status](#zoom-in-styles-status--what-a-cells-64-pixels-can-say) 2830, [UI improvements](#ui-improvements--overnight-run-section-9) 2697, [Live tunables panel](#live-tunables-panel--overnight-run-section-10) 2742, [Rendering performance](#rendering-performance--overnight-run-section-11) 2810, [M6 deferral](#m6-deferral) 1292 |
| **performance and the parallel sweep** | engine | [Performance](#performance) 6679, [M5 status](#m5-status) 1302, [Architecture](#architecture) 353, [Rendering performance](#rendering-performance--overnight-run-section-11) 2810, [Lab speed-dial status](#lab-speed-dial-status--what-the-dial-is-actually-short-of) 7099 |
| **materials and the data schema** | engine | [Materials](#materials) 279, [M12/M13 status](#m12m13-status) 802 |
| **the evolution lab — the box and its lights** | lab | [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 5211, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-anywhere-in-the-bed-and-a-bed-that-stops-running-out) 7385 |
| **reading one specimen off the screen** | lab | [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 5338 |
| **keeping, cloning and mutating an individual** | lab | [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 6479 |
| **finding one individual among all of them** | lab | [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 5386 |
| **the genome in plain words** | lab | [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 5617 |
| **what an individual has done, and what killed it** | lab | [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 6371 |
| **watching one individual over time** | lab | [Watch status](#watch-status--where-one-individual-has-been-and-how-its-numbers-moved) 5742 |
| **comparing two individuals** | lab | [Side-by-side status](#side-by-side-status--two-individuals-with-what-differs-marked) 5807 |
| **which founding line is winning** | lab | [Lineage overlay status](#lineage-overlay-status--which-founding-line-is-taking-the-bed) 5869 |
| **who is who in the box, colonies and the rivalry rule** | lab | [Creature groups status](#creature-groups-status--who-is-who-in-the-box-and-who-is-family) 5949 |
| **putting things in the box, and what the view shows** | lab | [Lab hand-verbs status](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) 6541 |
| **the chronicle: names, line events, and a clock that reacts** | lab | [Chronicle status](#chronicle-status--the-box-tells-you-who-did-what-at-any-population) 7542, [Event reaction status](#event-reaction-status--the-box-calls-you-back) 7610, [Life marks status](#life-marks-status--a-pause-time-mark-and-what-the-owner-rejected) 7650 |
| **a hand in the box: scent, alarm, fling, lamp** | lab | [Creature tools status](#creature-tools-status--a-hand-in-the-box-scent-alarm-fling-lamp) 7796 |
| **the speed dial, and what a tick costs** | lab | [Lab speed-dial status](#lab-speed-dial-status--what-the-dial-is-actually-short-of) 7099 |
| **tuning and saving the box's own numbers** | lab | [Lab parameters status](#lab-parameters-status--a-save-that-reaches-the-founders-not-just-the-file) 6629 |
| **a saved starting box, and replicating it in a rack** | lab | [Lab scenarios status](#lab-scenarios-status--a-saved-starting-box-with-a-question-written-on-it) 7256 |
