...
Generated by `scripts/readmetoc.py` from the `##` headings — 72 of
...
|---|---|
| [Running](#running) | 172 |
| [Finding things](#finding-things) | 188 |
| [Controls](#controls) | 224 |
| [Materials](#materials) | 295 |
| [Architecture](#architecture) | 369 |
| [The coarse field grid](#the-coarse-field-grid) | 571 |
| [M12/M13 status](#m12m13-status) | 833 |
| [Canopy throughfall status — rain drips through a wood](#canopy-throughfall-status--rain-drips-through-a-wood) | 860 |
| [Liquid physics: compressible volume, not discrete occupied cells](#liquid-physics-compressible-volume-not-discrete-occupied-cells) | 989 |
| [M14 status](#m14-status) | 1015 |
| [M7 status](#m7-status) | 1163 |
| [M15 status](#m15-status) | 1192 |
| [M6 deferral](#m6-deferral) | 1323 |
| [M5 status](#m5-status) | 1333 |
| [Plant lines merged: the genome, and the ecology](#plant-lines-merged-the-genome-and-the-ecology) | 1428 |
| [The generation loop: plants die, seeds expire, slots come back](#the-generation-loop-plants-die-seeds-expire-slots-come-back) | 1498 |
| [The economy re-derived: standing tissue costs something](#the-economy-re-derived-standing-tissue-costs-something) | 1579 |
| [Stems draw a line: the growth walk renders its heading](#stems-draw-a-line-the-growth-walk-renders-its-heading) | 1787 |
| [Plants that stop: organs, determinacy, and a price on both](#plants-that-stop-organs-determinacy-and-a-price-on-both) | 1869 |
| [M16 status](#m16-status) | 1937 |
| [M17 status](#m17-status) | 2123 |
| [M18 status](#m18-status) | 2350 |
| [UI improvements — overnight run, section 9](#ui-improvements--overnight-run-section-9) | 2757 |
| [Live tunables panel — overnight run, section 10](#live-tunables-panel--overnight-run-section-10) | 2802 |
| [Rendering performance — overnight run, section 11](#rendering-performance--overnight-run-section-11) | 2870 |
| [Zoom-out resolution status — more pixels instead of fewer cells](#zoom-out-resolution-status--more-pixels-instead-of-fewer-cells) | 2890 |
| [Zoom-in styles status — what a cell's 64 pixels can say](#zoom-in-styles-status--what-a-cells-64-pixels-can-say) | 3059 |
| [M8 status — started, not complete](#m8-status--started-not-complete) | 3118 |
| [M9 status — the gnome](#m9-status--the-gnome) | 3231 |
| [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3737 |
| [Weather status](#weather-status) | 3907 |
| [The ant colony — status](#the-ant-colony--status) | 3924 |
| [Inheritance status — the growth program has no fallback under it](#inheritance-status--the-growth-program-has-no-fallback-under-it) | 4716 |
| [Parameter-genome status — a species file is a starting point, and it ships inert](#parameter-genome-status--a-species-file-is-a-starting-point-and-it-ships-inert) | 4819 |
| [M19 status — started](#m19-status--started) | 4927 |
| [Felling status — the verb works, and what it produces is pieces](#felling-status--the-verb-works-and-what-it-produces-is-pieces) | 4999 |
| [Bending status — soft tissue lies over, and the wind is what pushes it](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) | 5236 |
| [Breaking status — a badly grown tree comes down on its own](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) | 5313 |
| [Lab lighting status — the fixtures are what light the crop](#lab-lighting-status--the-fixtures-are-what-light-the-crop) | 5506 |
| [Cell page status — the specimen readout is in three groups, and folds](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) | 5633 |
| [Roster status — every plant and every animal, as a list you click through](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) | 5681 |
| [Plain-speech status — the genome read back as sentences](#plain-speech-status--the-genome-read-back-as-sentences) | 5912 |
| [Watch status — where one individual has been, and how its numbers moved](#watch-status--where-one-individual-has-been-and-how-its-numbers-moved) | 6037 |
| [Side-by-side status — two individuals, with what differs marked](#side-by-side-status--two-individuals-with-what-differs-marked) | 6102 |
| [Lineage overlay status — which founding line is taking the bed](#lineage-overlay-status--which-founding-line-is-taking-the-bed) | 6164 |
| [Creature groups status — who is who in the box, and who is family](#creature-groups-status--who-is-who-in-the-box-and-who-is-family) | 6244 |
| [Life record status — what an individual has done, and what killed it](#life-record-status--what-an-individual-has-done-and-what-killed-it) | 6666 |
| [Specimen shelf status — an individual's genetics outlive the box](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) | 6774 |
| [Lab hand-verbs status — what a click puts in the box, and what the view shows](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) | 6836 |
| [Lab parameters status — a save that reaches the founders, not just the file](#lab-parameters-status--a-save-that-reaches-the-founders-not-just-the-file) | 6924 |
| [Performance](#performance) | 6974 |
| [World speed — five independent time axes](#world-speed--five-independent-time-axes) | 7171 |
| [Status](#status) | 7254 |
| [License](#license) | 7365 |
| [Lab speed-dial status — what the dial is actually short of](#lab-speed-dial-status--what-the-dial-is-actually-short-of) | 7389 |
| [Lab scenarios status — a saved starting box with a question written on it](#lab-scenarios-status--a-saved-starting-box-with-a-question-written-on-it) | 7546 |
| [Soil nutrient status — ground is worth something water is not](#soil-nutrient-status--ground-is-worth-something-water-is-not) | 7649 |
| [Lab soil status — a hole that stays a hole anywhere in the bed, and a bed that stops running out](#lab-soil-status--a-hole-that-stays-a-hole-anywhere-in-the-bed-and-a-bed-that-stops-running-out) | 7692 |
| [Chronicle status — the box tells you who did what, at any population](#chronicle-status--the-box-tells-you-who-did-what-at-any-population) | 7849 |
| [Event reaction status — the box calls you back](#event-reaction-status--the-box-calls-you-back) | 7917 |
| [Life marks status — a pause-time mark, and what the owner rejected](#life-marks-status--a-pause-time-mark-and-what-the-owner-rejected) | 7957 |
| [Hunger status — a fed ant rests, a hungry one walks, and the founding cliff is walking cost](#hunger-status--a-fed-ant-rests-a-hungry-one-walks-and-the-founding-cliff-is-walking-cost) | 7992 |
| [Hopper status — the jump has a species, and it hops itself to death](#hopper-status--the-jump-has-a-species-and-it-hops-itself-to-death) | 8072 |
| [Rest status — a rest that ends, so a resting animal is not a stopped one](#rest-status--a-rest-that-ends-so-a-resting-animal-is-not-a-stopped-one) | 8103 |
| [Creature tools status — a hand in the box: scent, alarm, fling, lamp](#creature-tools-status--a-hand-in-the-box-scent-alarm-fling-lamp) | 8177 |
| [Trophallaxis status — the colony's stomach, shipped on, and a first measurement that says wait](#trophallaxis-status--the-colonys-stomach-shipped-on-and-a-first-measurement-that-says-wait) | 8234 |
| [Stacking status — many ants of one colony in one cell, off by default](#stacking-status--many-ants-of-one-colony-in-one-cell-off-by-default) | 8292 |
| [Trail status — the ant reads its way home, and the food trail is the larder's problem](#trail-status--the-ant-reads-its-way-home-and-the-food-trail-is-the-larders-problem) | 8346 |
| [Lifespan status — an ant gets old, and the colony's fall becomes a slope](#lifespan-status--an-ant-gets-old-and-the-colonys-fall-becomes-a-slope) | 8383 |
| [Held world status — the third game, and time you carry in a circle](#held-world-status--the-third-game-and-time-you-carry-in-a-circle) | 8529 |
| [Colony books status — what each colony is living on, in joules](#colony-books-status--what-each-colony-is-living-on-in-joules) | 9437 |
| [Food road status — the trail the colony actually walks, and the box that was not there](#food-road-status--the-trail-the-colony-actually-walks-and-the-box-that-was-not-there) | 9568 |
...
| M | Section | Line |
|---|---|---|
| 5 | [M5 status](#m5-status) | 1333 |
| 6 | [M6 deferral](#m6-deferral) | 1323 |
| 7 | [M7 status](#m7-status) | 1163 |
| 8 | [M8 status — started, not complete](#m8-status--started-not-complete) | 3118 |
| 9 | [M9 status — the gnome](#m9-status--the-gnome) | 3231 |
| 10 | [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3737 |
| 12 | [M12/M13 status](#m12m13-status) | 833 |
| 14 | [M14 status](#m14-status) | 1015 |
| 15 | [M15 status](#m15-status) | 1192 |
| 16 | [M16 status](#m16-status) | 1937 |
| 17 | [M17 status](#m17-status) | 2123 |
| 18 | [M18 status](#m18-status) | 2350 |
| 19 | [M19 status — started](#m19-status--started) | 4927 |
...
[Status](#status), line 7254 — the *last* section in the
...
|---|---|---|
| **plants, trees and moss** | engine | [M16 status](#m16-status) 1937, [Soil nutrient status](#soil-nutrient-status--ground-is-worth-something-water-is-not) 7649, [Plant lines merged](#plant-lines-merged-the-genome-and-the-ecology) 1428, [Inheritance status](#inheritance-status--the-growth-program-has-no-fallback-under-it) 4716, [Parameter-genome status](#parameter-genome-status--a-species-file-is-a-starting-point-and-it-ships-inert) 4819, [The economy re-derived](#the-economy-re-derived-standing-tissue-costs-something) 1579, [Plants that stop](#plants-that-stop-organs-determinacy-and-a-price-on-both) 1869, [The generation loop](#the-generation-loop-plants-die-seeds-expire-slots-come-back) 1498, [Stems draw a line](#stems-draw-a-line-the-growth-walk-renders-its-heading) 1787, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 4999, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 5236, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 5313, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 6774, [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 5633, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 5681, [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 5912, [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 6666 |
| **creatures — worms and the ant colony** | engine | [M18 status](#m18-status) 2350, [The ant colony](#the-ant-colony--status) 3924, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 6774, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 5681, [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 5912, [Lab hand-verbs status](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) 6836, [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 6666, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-anywhere-in-the-bed-and-a-bed-that-stops-running-out) 7692, [Hunger status](#hunger-status--a-fed-ant-rests-a-hungry-one-walks-and-the-founding-cliff-is-walking-cost) 7992, [Rest status](#rest-status--a-rest-that-ends-so-a-resting-animal-is-not-a-stopped-one) 8103, [Hopper status](#hopper-status--the-jump-has-a-species-and-it-hops-itself-to-death) 8072, [Trophallaxis status](#trophallaxis-status--the-colonys-stomach-shipped-on-and-a-first-measurement-that-says-wait) 8234, [Stacking status](#stacking-status--many-ants-of-one-colony-in-one-cell-off-by-default) 8292, [Trail status](#trail-status--the-ant-reads-its-way-home-and-the-food-trail-is-the-larders-problem) 8346, [Lifespan status](#lifespan-status--an-ant-gets-old-and-the-colonys-fall-becomes-a-slope) 8383, [Colony books status](#colony-books-status--what-each-colony-is-living-on-in-joules) 9437, [Food road status](#food-road-status--the-trail-the-colony-actually-walks-and-the-box-that-was-not-there) 9568 |
| **structural collapse, felling and rigid bodies** | outdoor | [M17 status](#m17-status) 2123, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 4999, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 5236, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 5313, [M8 status](#m8-status--started-not-complete) 3118 |
| **fire, heat and phase change** | engine | [M14 status](#m14-status) 1015, [Materials](#materials) 295 |
| **explosions, particles and debris** | outdoor | [M15 status](#m15-status) 1192, [M7 status](#m7-status) 1163 |
| **liquids and gases** | engine | [Liquid physics](#liquid-physics-compressible-volume-not-discrete-occupied-cells) 989, [Canopy throughfall status](#canopy-throughfall-status--rain-drips-through-a-wood) 860, [The coarse field grid](#the-coarse-field-grid) 571 |
| **powders and granular flow** | engine | [Materials](#materials) 295, [Architecture](#architecture) 369, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-anywhere-in-the-bed-and-a-bed-that-stops-running-out) 7692 |
| **the coarse field grid — pressure, heat, light** | engine | [The coarse field grid](#the-coarse-field-grid) 571, [M12/M13 status](#m12m13-status) 833, [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 5506 |
| **worldgen and world structure** | outdoor | [M10 status](#m10-status--the-worldgen-half) 3737, [Architecture](#architecture) 369 |
| **the gnome (player character)** | outdoor | [M9 status](#m9-status--the-gnome) 3231, [Controls](#controls) 224 |
| **weather, sky and the clock** | engine | [Weather status](#weather-status) 3907, [M19 status](#m19-status--started) 4927, [World speed](#world-speed--five-independent-time-axes) 7171 |
| **rendering, UI and tunables** | engine | [Zoom-out resolution status](#zoom-out-resolution-status--more-pixels-instead-of-fewer-cells) 2890, [Zoom-in styles status](#zoom-in-styles-status--what-a-cells-64-pixels-can-say) 3059, [UI improvements](#ui-improvements--overnight-run-section-9) 2757, [Live tunables panel](#live-tunables-panel--overnight-run-section-10) 2802, [Rendering performance](#rendering-performance--overnight-run-section-11) 2870, [M6 deferral](#m6-deferral) 1323 |
| **performance and the parallel sweep** | engine | [Performance](#performance) 6974, [M5 status](#m5-status) 1333, [Architecture](#architecture) 369, [Rendering performance](#rendering-performance--overnight-run-section-11) 2870, [Lab speed-dial status](#lab-speed-dial-status--what-the-dial-is-actually-short-of) 7389 |
| **materials and the data schema** | engine | [Materials](#materials) 295, [M12/M13 status](#m12m13-status) 833 |
| **the evolution lab — the box and its lights** | lab | [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 5506, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-anywhere-in-the-bed-and-a-bed-that-stops-running-out) 7692 |
| **reading one specimen off the screen** | lab | [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 5633 |
| **keeping, cloning and mutating an individual** | lab | [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 6774 |
| **finding one individual among all of them** | lab | [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 5681 |
| **the genome in plain words** | lab | [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 5912 |
| **what an individual has done, and what killed it** | lab | [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 6666 |
| **watching one individual over time** | lab | [Watch status](#watch-status--where-one-individual-has-been-and-how-its-numbers-moved) 6037 |
| **comparing two individuals** | lab | [Side-by-side status](#side-by-side-status--two-individuals-with-what-differs-marked) 6102 |
| **which founding line is winning** | lab | [Lineage overlay status](#lineage-overlay-status--which-founding-line-is-taking-the-bed) 6164 |
| **who is who in the box, colonies and the rivalry rule** | lab | [Creature groups status](#creature-groups-status--who-is-who-in-the-box-and-who-is-family) 6244 |
| **putting things in the box, and what the view shows** | lab | [Lab hand-verbs status](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) 6836 |
| **the chronicle: names, line events, and a clock that reacts** | lab | [Chronicle status](#chronicle-status--the-box-tells-you-who-did-what-at-any-population) 7849, [Event reaction status](#event-reaction-status--the-box-calls-you-back) 7917, [Life marks status](#life-marks-status--a-pause-time-mark-and-what-the-owner-rejected) 7957 |
| **a hand in the box: scent, alarm, fling, lamp** | lab | [Creature tools status](#creature-tools-status--a-hand-in-the-box-scent-alarm-fling-lamp) 8177 |
| **the speed dial, and what a tick costs** | lab | [Lab speed-dial status](#lab-speed-dial-status--what-the-dial-is-actually-short-of) 7389 |
| **tuning and saving the box's own numbers** | lab | [Lab parameters status](#lab-parameters-status--a-save-that-reaches-the-founders-not-just-the-file) 6924 |
| **a saved starting box, and replicating it in a rack** | lab | [Lab scenarios status](#lab-scenarios-status--a-saved-starting-box-with-a-question-written-on-it) 7546 |
| **the held world — the third game, and time you carry** | held | [Held world status](#held-world-status--the-third-game-and-time-you-carry-in-a-circle) 8529 |
