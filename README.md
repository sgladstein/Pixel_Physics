...
Generated by `scripts/readmetoc.py` from the `##` headings — 42 of
...
|---|---|
| [Running](#running) | 129 |
| [Finding things](#finding-things) | 137 |
| [Controls](#controls) | 173 |
| [Materials](#materials) | 239 |
| [Architecture](#architecture) | 313 |
| [The coarse field grid](#the-coarse-field-grid) | 497 |
| [M12/M13 status](#m12m13-status) | 759 |
| [Liquid physics: compressible volume, not discrete occupied cells](#liquid-physics-compressible-volume-not-discrete-occupied-cells) | 786 |
| [M14 status](#m14-status) | 812 |
| [M7 status](#m7-status) | 960 |
| [M15 status](#m15-status) | 989 |
| [M6 deferral](#m6-deferral) | 1120 |
| [M5 status](#m5-status) | 1130 |
| [Plant lines merged: the genome, and the ecology](#plant-lines-merged-the-genome-and-the-ecology) | 1225 |
| [The generation loop: plants die, seeds expire, slots come back](#the-generation-loop-plants-die-seeds-expire-slots-come-back) | 1295 |
| [The economy re-derived: standing tissue costs something](#the-economy-re-derived-standing-tissue-costs-something) | 1347 |
| [Stems draw a line: the growth walk renders its heading](#stems-draw-a-line-the-growth-walk-renders-its-heading) | 1447 |
| [Plants that stop: organs, determinacy, and a price on both](#plants-that-stop-organs-determinacy-and-a-price-on-both) | 1529 |
| [M16 status](#m16-status) | 1597 |
| [M17 status](#m17-status) | 1783 |
| [M18 status](#m18-status) | 2010 |
| [UI improvements — overnight run, section 9](#ui-improvements--overnight-run-section-9) | 2344 |
| [Live tunables panel — overnight run, section 10](#live-tunables-panel--overnight-run-section-10) | 2389 |
| [Rendering performance — overnight run, section 11](#rendering-performance--overnight-run-section-11) | 2457 |
| [M8 status — started, not complete](#m8-status--started-not-complete) | 2477 |
| [M9 status — the gnome](#m9-status--the-gnome) | 2590 |
| [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3030 |
| [Weather status](#weather-status) | 3200 |
| [The ant colony — status](#the-ant-colony--status) | 3217 |
| [Inheritance status — the growth program has no fallback under it](#inheritance-status--the-growth-program-has-no-fallback-under-it) | 3575 |
| [M19 status — started](#m19-status--started) | 3678 |
| [Felling status — the verb works, and what it produces is pieces](#felling-status--the-verb-works-and-what-it-produces-is-pieces) | 3750 |
| [Bending status — soft tissue lies over, and the wind is what pushes it](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) | 3987 |
| [Breaking status — a badly grown tree comes down on its own](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) | 4064 |
| [Lab lighting status — the fixtures are what light the crop](#lab-lighting-status--the-fixtures-are-what-light-the-crop) | 4257 |
| [Cell page status — the specimen readout is in three groups, and folds](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) | 4319 |
| [Roster status — every plant and every animal, as a list you click through](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) | 4367 |
| [Specimen shelf status — an individual's genetics outlive the box](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) | 4465 |
| [Performance](#performance) | 4527 |
| [World speed — five independent time axes](#world-speed--five-independent-time-axes) | 4724 |
| [Status](#status) | 4807 |
| [License](#license) | 4918 |
...
| M | Section | Line |
|---|---|---|
| 5 | [M5 status](#m5-status) | 1130 |
| 6 | [M6 deferral](#m6-deferral) | 1120 |
| 7 | [M7 status](#m7-status) | 960 |
| 8 | [M8 status — started, not complete](#m8-status--started-not-complete) | 2477 |
| 9 | [M9 status — the gnome](#m9-status--the-gnome) | 2590 |
| 10 | [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3030 |
| 12 | [M12/M13 status](#m12m13-status) | 759 |
| 14 | [M14 status](#m14-status) | 812 |
| 15 | [M15 status](#m15-status) | 989 |
| 16 | [M16 status](#m16-status) | 1597 |
| 17 | [M17 status](#m17-status) | 1783 |
| 18 | [M18 status](#m18-status) | 2010 |
| 19 | [M19 status — started](#m19-status--started) | 3678 |
...
[Status](#status), line 4807 — the *last* section in the
...
|---|---|---|
| **plants, trees and moss** | engine | [M16 status](#m16-status) 1597, [Plant lines merged](#plant-lines-merged-the-genome-and-the-ecology) 1225, [Inheritance status](#inheritance-status--the-growth-program-has-no-fallback-under-it) 3575, [The economy re-derived](#the-economy-re-derived-standing-tissue-costs-something) 1347, [Plants that stop](#plants-that-stop-organs-determinacy-and-a-price-on-both) 1529, [The generation loop](#the-generation-loop-plants-die-seeds-expire-slots-come-back) 1295, [Stems draw a line](#stems-draw-a-line-the-growth-walk-renders-its-heading) 1447, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 3750, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 3987, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 4064, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 4465, [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 4319, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 4367 |
| **creatures — worms and the ant colony** | engine | [M18 status](#m18-status) 2010, [The ant colony](#the-ant-colony--status) 3217, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 4465, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 4367 |
| **structural collapse, felling and rigid bodies** | outdoor | [M17 status](#m17-status) 1783, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 3750, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 3987, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 4064, [M8 status](#m8-status--started-not-complete) 2477 |
| **fire, heat and phase change** | engine | [M14 status](#m14-status) 812, [Materials](#materials) 239 |
| **explosions, particles and debris** | outdoor | [M15 status](#m15-status) 989, [M7 status](#m7-status) 960 |
| **liquids and gases** | engine | [Liquid physics](#liquid-physics-compressible-volume-not-discrete-occupied-cells) 786, [The coarse field grid](#the-coarse-field-grid) 497 |
| **powders and granular flow** | engine | [Materials](#materials) 239, [Architecture](#architecture) 313 |
| **the coarse field grid — pressure, heat, light** | engine | [The coarse field grid](#the-coarse-field-grid) 497, [M12/M13 status](#m12m13-status) 759, [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 4257 |
| **worldgen and world structure** | outdoor | [M10 status](#m10-status--the-worldgen-half) 3030, [Architecture](#architecture) 313 |
| **the gnome (player character)** | outdoor | [M9 status](#m9-status--the-gnome) 2590, [Controls](#controls) 173 |
| **weather, sky and the clock** | engine | [Weather status](#weather-status) 3200, [M19 status](#m19-status--started) 3678, [World speed](#world-speed--five-independent-time-axes) 4724 |
| **rendering, UI and tunables** | engine | [UI improvements](#ui-improvements--overnight-run-section-9) 2344, [Live tunables panel](#live-tunables-panel--overnight-run-section-10) 2389, [Rendering performance](#rendering-performance--overnight-run-section-11) 2457, [M6 deferral](#m6-deferral) 1120 |
| **performance and the parallel sweep** | engine | [Performance](#performance) 4527, [M5 status](#m5-status) 1130, [Architecture](#architecture) 313, [Rendering performance](#rendering-performance--overnight-run-section-11) 2457 |
| **materials and the data schema** | engine | [Materials](#materials) 239, [M12/M13 status](#m12m13-status) 759 |
| **the evolution lab — the box and its lights** | lab | [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 4257 |
| **reading one specimen off the screen** | lab | [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 4319 |
| **keeping, cloning and mutating an individual** | lab | [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 4465 |
| **finding one individual among all of them** | lab | [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 4367 |
