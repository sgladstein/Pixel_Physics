...
| [Performance](#performance) | 3231 |
| [World speed — five independent time axes](#world-speed--five-independent-time-axes) | 3405 |
| [Status](#status) | 3488 |
| [License](#license) | 3599 |
...
| 19 | [M19 status — started](#m19-status--started) | 2938 |
...
[Status](#status), line 3488 — the *last* section in the
...
| **weather, sky and the clock** | [Weather status](#weather-status) 2812, [M19 status](#m19-status--started) 2938, [World speed](#world-speed--five-independent-time-axes) 3405 |
...
| **performance and the parallel sweep** | [Performance](#performance) 3231, [M5 status](#m5-status) 1085, [Architecture](#architecture) 295, [Rendering performance](#rendering-performance--overnight-run-section-11) 2412 |
