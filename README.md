...
Generated by `scripts/readmetoc.py` from the `##` headings — 37 of
...
|---|---|
| [Running](#running) | 114 |
| [Finding things](#finding-things) | 122 |
| [Controls](#controls) | 158 |
| [Materials](#materials) | 223 |
| [Architecture](#architecture) | 297 |
| [The coarse field grid](#the-coarse-field-grid) | 457 |
| [M12/M13 status](#m12m13-status) | 719 |
| [Liquid physics: compressible volume, not discrete occupied cells](#liquid-physics-compressible-volume-not-discrete-occupied-cells) | 746 |
| [M14 status](#m14-status) | 772 |
| [M7 status](#m7-status) | 920 |
| [M15 status](#m15-status) | 949 |
| [M6 deferral](#m6-deferral) | 1080 |
| [M5 status](#m5-status) | 1090 |
| [Plant lines merged: the genome, and the ecology](#plant-lines-merged-the-genome-and-the-ecology) | 1185 |
| [The generation loop: plants die, seeds expire, slots come back](#the-generation-loop-plants-die-seeds-expire-slots-come-back) | 1255 |
| [The economy re-derived: standing tissue costs something](#the-economy-re-derived-standing-tissue-costs-something) | 1307 |
| [Stems draw a line: the growth walk renders its heading](#stems-draw-a-line-the-growth-walk-renders-its-heading) | 1407 |
| [Plants that stop: organs, determinacy, and a price on both](#plants-that-stop-organs-determinacy-and-a-price-on-both) | 1489 |
| [M16 status](#m16-status) | 1557 |
| [M17 status](#m17-status) | 1743 |
| [M18 status](#m18-status) | 1970 |
| [UI improvements — overnight run, section 9](#ui-improvements--overnight-run-section-9) | 2304 |
| [Live tunables panel — overnight run, section 10](#live-tunables-panel--overnight-run-section-10) | 2349 |
| [Rendering performance — overnight run, section 11](#rendering-performance--overnight-run-section-11) | 2417 |
| [M8 status — started, not complete](#m8-status--started-not-complete) | 2437 |
| [M9 status — the gnome](#m9-status--the-gnome) | 2550 |
| [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 2935 |
| [Weather status](#weather-status) | 3105 |
| [The ant colony — status](#the-ant-colony--status) | 3122 |
| [M19 status — started](#m19-status--started) | 3231 |
| [Felling status — the verb works, and what it produces is pieces](#felling-status--the-verb-works-and-what-it-produces-is-pieces) | 3303 |
| [Bending status — soft tissue lies over, and the wind is what pushes it](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) | 3540 |
| [Breaking status — a badly grown tree comes down on its own](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) | 3617 |
| [Performance](#performance) | 3709 |
| [World speed — five independent time axes](#world-speed--five-independent-time-axes) | 3906 |
| [Status](#status) | 3989 |
| [License](#license) | 4100 |
...
| M | Section | Line |
|---|---|---|
| 5 | [M5 status](#m5-status) | 1090 |
| 6 | [M6 deferral](#m6-deferral) | 1080 |
| 7 | [M7 status](#m7-status) | 920 |
| 8 | [M8 status — started, not complete](#m8-status--started-not-complete) | 2437 |
| 9 | [M9 status — the gnome](#m9-status--the-gnome) | 2550 |
| 10 | [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 2935 |
| 12 | [M12/M13 status](#m12m13-status) | 719 |
| 14 | [M14 status](#m14-status) | 772 |
| 15 | [M15 status](#m15-status) | 949 |
| 16 | [M16 status](#m16-status) | 1557 |
| 17 | [M17 status](#m17-status) | 1743 |
| 18 | [M18 status](#m18-status) | 1970 |
| 19 | [M19 status — started](#m19-status--started) | 3231 |
...
[Status](#status), line 3989 — the *last* section in the
file, not the first. Read it before concluding something is broken.

| Topic | Sections, primary first |
|---|---|
| **plants, trees and moss** | [M16 status](#m16-status) 1557, [Plant lines merged](#plant-lines-merged-the-genome-and-the-ecology) 1185, [The economy re-derived](#the-economy-re-derived-standing-tissue-costs-something) 1307, [Plants that stop](#plants-that-stop-organs-determinacy-and-a-price-on-both) 1489, [The generation loop](#the-generation-loop-plants-die-seeds-expire-slots-come-back) 1255, [Stems draw a line](#stems-draw-a-line-the-growth-walk-renders-its-heading) 1407, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 3303, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 3540, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 3617 |
| **creatures — worms and the ant colony** | [M18 status](#m18-status) 1970, [The ant colony](#the-ant-colony--status) 3122 |
| **structural collapse, felling and rigid bodies** | [M17 status](#m17-status) 1743, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 3303, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 3540, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 3617, [M8 status](#m8-status--started-not-complete) 2437 |
| **fire, heat and phase change** | [M14 status](#m14-status) 772, [Materials](#materials) 223 |
| **explosions, particles and debris** | [M15 status](#m15-status) 949, [M7 status](#m7-status) 920 |
| **liquids and gases** | [Liquid physics](#liquid-physics-compressible-volume-not-discrete-occupied-cells) 746, [The coarse field grid](#the-coarse-field-grid) 457 |
| **powders and granular flow** | [Materials](#materials) 223, [Architecture](#architecture) 297 |
| **the coarse field grid — pressure, heat, light** | [The coarse field grid](#the-coarse-field-grid) 457, [M12/M13 status](#m12m13-status) 719 |
| **worldgen and world structure** | [M10 status](#m10-status--the-worldgen-half) 2935, [Architecture](#architecture) 297 |
| **the gnome (player character)** | [M9 status](#m9-status--the-gnome) 2550, [Controls](#controls) 158 |
| **weather, sky and the clock** | [Weather status](#weather-status) 3105, [M19 status](#m19-status--started) 3231, [World speed](#world-speed--five-independent-time-axes) 3906 |
| **rendering, UI and tunables** | [UI improvements](#ui-improvements--overnight-run-section-9) 2304, [Live tunables panel](#live-tunables-panel--overnight-run-section-10) 2349, [Rendering performance](#rendering-performance--overnight-run-section-11) 2417, [M6 deferral](#m6-deferral) 1080 |
| **performance and the parallel sweep** | [Performance](#performance) 3709, [M5 status](#m5-status) 1090, [Architecture](#architecture) 297, [Rendering performance](#rendering-performance--overnight-run-section-11) 2417 |
| **materials and the data schema** | [Materials](#materials) 223, [M12/M13 status](#m12m13-status) 719 |
