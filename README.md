...
| [Lab soil status — a hole that stays a hole, and a bed that stops running out](#lab-soil-status--a-hole-that-stays-a-hole-and-a-bed-that-stops-running-out) | 6627 |
...
| **creatures — worms and the ant colony** | engine | [M18 status](#m18-status) 2138, [The ant colony](#the-ant-colony--status) 3393, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 5808, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 5137, [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 5368, [Lab hand-verbs status](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) 5870, [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 5700, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-and-a-bed-that-stops-running-out) 6627 |
...
| **powders and granular flow** | engine | [Materials](#materials) 259, [Architecture](#architecture) 333, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-and-a-bed-that-stops-running-out) 6627 |
...
| **the evolution lab — the box and its lights** | lab | [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 4962, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-and-a-bed-that-stops-running-out) 6627 |
