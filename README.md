...
Generated by `scripts/readmetoc.py` from the `##` headings — 52 of
...
|---|---|
| [Running](#running) | 147 |
| [Finding things](#finding-things) | 155 |
| [Controls](#controls) | 191 |
| [Materials](#materials) | 257 |
| [Architecture](#architecture) | 331 |
| [The coarse field grid](#the-coarse-field-grid) | 515 |
| [M12/M13 status](#m12m13-status) | 777 |
| [Liquid physics: compressible volume, not discrete occupied cells](#liquid-physics-compressible-volume-not-discrete-occupied-cells) | 804 |
| [M14 status](#m14-status) | 830 |
| [M7 status](#m7-status) | 978 |
| [M15 status](#m15-status) | 1007 |
| [M6 deferral](#m6-deferral) | 1138 |
| [M5 status](#m5-status) | 1148 |
| [Plant lines merged: the genome, and the ecology](#plant-lines-merged-the-genome-and-the-ecology) | 1243 |
| [The generation loop: plants die, seeds expire, slots come back](#the-generation-loop-plants-die-seeds-expire-slots-come-back) | 1313 |
| [The economy re-derived: standing tissue costs something](#the-economy-re-derived-standing-tissue-costs-something) | 1365 |
| [Stems draw a line: the growth walk renders its heading](#stems-draw-a-line-the-growth-walk-renders-its-heading) | 1573 |
| [Plants that stop: organs, determinacy, and a price on both](#plants-that-stop-organs-determinacy-and-a-price-on-both) | 1655 |
| [M16 status](#m16-status) | 1723 |
| [M17 status](#m17-status) | 1909 |
| [M18 status](#m18-status) | 2136 |
| [UI improvements — overnight run, section 9](#ui-improvements--overnight-run-section-9) | 2518 |
| [Live tunables panel — overnight run, section 10](#live-tunables-panel--overnight-run-section-10) | 2563 |
| [Rendering performance — overnight run, section 11](#rendering-performance--overnight-run-section-11) | 2631 |
| [M8 status — started, not complete](#m8-status--started-not-complete) | 2651 |
| [M9 status — the gnome](#m9-status--the-gnome) | 2764 |
| [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3204 |
| [Weather status](#weather-status) | 3374 |
| [The ant colony — status](#the-ant-colony--status) | 3391 |
| [Inheritance status — the growth program has no fallback under it](#inheritance-status--the-growth-program-has-no-fallback-under-it) | 4170 |
| [Parameter-genome status — a species file is a starting point, and it ships inert](#parameter-genome-status--a-species-file-is-a-starting-point-and-it-ships-inert) | 4273 |
| [M19 status — started](#m19-status--started) | 4381 |
| [Felling status — the verb works, and what it produces is pieces](#felling-status--the-verb-works-and-what-it-produces-is-pieces) | 4453 |
| [Bending status — soft tissue lies over, and the wind is what pushes it](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) | 4690 |
| [Breaking status — a badly grown tree comes down on its own](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) | 4767 |
| [Lab lighting status — the fixtures are what light the crop](#lab-lighting-status--the-fixtures-are-what-light-the-crop) | 4960 |
| [Cell page status — the specimen readout is in three groups, and folds](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) | 5087 |
| [Roster status — every plant and every animal, as a list you click through](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) | 5135 |
| [Plain-speech status — the genome read back as sentences](#plain-speech-status--the-genome-read-back-as-sentences) | 5366 |
| [Watch status — where one individual has been, and how its numbers moved](#watch-status--where-one-individual-has-been-and-how-its-numbers-moved) | 5491 |
| [Side-by-side status — two individuals, with what differs marked](#side-by-side-status--two-individuals-with-what-differs-marked) | 5556 |
| [Lineage overlay status — which founding line is taking the bed](#lineage-overlay-status--which-founding-line-is-taking-the-bed) | 5618 |
| [Life record status — what an individual has done, and what killed it](#life-record-status--what-an-individual-has-done-and-what-killed-it) | 5698 |
| [Specimen shelf status — an individual's genetics outlive the box](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) | 5806 |
| [Lab hand-verbs status — what a click puts in the box, and what the view shows](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) | 5868 |
| [Lab parameters status — a save that reaches the founders, not just the file](#lab-parameters-status--a-save-that-reaches-the-founders-not-just-the-file) | 5956 |
| [Performance](#performance) | 6006 |
| [World speed — five independent time axes](#world-speed--five-independent-time-axes) | 6203 |
| [Status](#status) | 6286 |
| [License](#license) | 6397 |
| [Lab speed-dial status — what the dial is actually short of](#lab-speed-dial-status--what-the-dial-is-actually-short-of) | 6421 |
| [Lab soil status — a hole that stays a hole, and a bed that stops running out](#lab-soil-status--a-hole-that-stays-a-hole-and-a-bed-that-stops-running-out) | 6539 |
...
| M | Section | Line |
|---|---|---|
| 5 | [M5 status](#m5-status) | 1148 |
| 6 | [M6 deferral](#m6-deferral) | 1138 |
| 7 | [M7 status](#m7-status) | 978 |
| 8 | [M8 status — started, not complete](#m8-status--started-not-complete) | 2651 |
| 9 | [M9 status — the gnome](#m9-status--the-gnome) | 2764 |
| 10 | [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3204 |
| 12 | [M12/M13 status](#m12m13-status) | 777 |
| 14 | [M14 status](#m14-status) | 830 |
| 15 | [M15 status](#m15-status) | 1007 |
| 16 | [M16 status](#m16-status) | 1723 |
| 17 | [M17 status](#m17-status) | 1909 |
| 18 | [M18 status](#m18-status) | 2136 |
| 19 | [M19 status — started](#m19-status--started) | 4381 |
...
[Status](#status), line 6286 — the *last* section in the
...
|---|---|---|
| **plants, trees and moss** | engine | [M16 status](#m16-status) 1723, [Plant lines merged](#plant-lines-merged-the-genome-and-the-ecology) 1243, [Inheritance status](#inheritance-status--the-growth-program-has-no-fallback-under-it) 4170, [Parameter-genome status](#parameter-genome-status--a-species-file-is-a-starting-point-and-it-ships-inert) 4273, [The economy re-derived](#the-economy-re-derived-standing-tissue-costs-something) 1365, [Plants that stop](#plants-that-stop-organs-determinacy-and-a-price-on-both) 1655, [The generation loop](#the-generation-loop-plants-die-seeds-expire-slots-come-back) 1313, [Stems draw a line](#stems-draw-a-line-the-growth-walk-renders-its-heading) 1573, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 4453, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 4690, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 4767, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 5806, [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 5087, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 5135, [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 5366, [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 5698 |
| **creatures — worms and the ant colony** | engine | [M18 status](#m18-status) 2136, [The ant colony](#the-ant-colony--status) 3391, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 5806, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 5135, [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 5366, [Lab hand-verbs status](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) 5868, [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 5698, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-and-a-bed-that-stops-running-out) 6539 |
| **structural collapse, felling and rigid bodies** | outdoor | [M17 status](#m17-status) 1909, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 4453, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 4690, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 4767, [M8 status](#m8-status--started-not-complete) 2651 |
| **fire, heat and phase change** | engine | [M14 status](#m14-status) 830, [Materials](#materials) 257 |
| **explosions, particles and debris** | outdoor | [M15 status](#m15-status) 1007, [M7 status](#m7-status) 978 |
| **liquids and gases** | engine | [Liquid physics](#liquid-physics-compressible-volume-not-discrete-occupied-cells) 804, [The coarse field grid](#the-coarse-field-grid) 515 |
| **powders and granular flow** | engine | [Materials](#materials) 257, [Architecture](#architecture) 331, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-and-a-bed-that-stops-running-out) 6539 |
| **the coarse field grid — pressure, heat, light** | engine | [The coarse field grid](#the-coarse-field-grid) 515, [M12/M13 status](#m12m13-status) 777, [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 4960 |
| **worldgen and world structure** | outdoor | [M10 status](#m10-status--the-worldgen-half) 3204, [Architecture](#architecture) 331 |
| **the gnome (player character)** | outdoor | [M9 status](#m9-status--the-gnome) 2764, [Controls](#controls) 191 |
| **weather, sky and the clock** | engine | [Weather status](#weather-status) 3374, [M19 status](#m19-status--started) 4381, [World speed](#world-speed--five-independent-time-axes) 6203 |
| **rendering, UI and tunables** | engine | [UI improvements](#ui-improvements--overnight-run-section-9) 2518, [Live tunables panel](#live-tunables-panel--overnight-run-section-10) 2563, [Rendering performance](#rendering-performance--overnight-run-section-11) 2631, [M6 deferral](#m6-deferral) 1138 |
| **performance and the parallel sweep** | engine | [Performance](#performance) 6006, [M5 status](#m5-status) 1148, [Architecture](#architecture) 331, [Rendering performance](#rendering-performance--overnight-run-section-11) 2631, [Lab speed-dial status](#lab-speed-dial-status--what-the-dial-is-actually-short-of) 6421 |
| **materials and the data schema** | engine | [Materials](#materials) 257, [M12/M13 status](#m12m13-status) 777 |
| **the evolution lab — the box and its lights** | lab | [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 4960, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-and-a-bed-that-stops-running-out) 6539 |
| **reading one specimen off the screen** | lab | [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 5087 |
| **keeping, cloning and mutating an individual** | lab | [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 5806 |
| **finding one individual among all of them** | lab | [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 5135 |
| **the genome in plain words** | lab | [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 5366 |
| **what an individual has done, and what killed it** | lab | [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 5698 |
| **watching one individual over time** | lab | [Watch status](#watch-status--where-one-individual-has-been-and-how-its-numbers-moved) 5491 |
| **comparing two individuals** | lab | [Side-by-side status](#side-by-side-status--two-individuals-with-what-differs-marked) 5556 |
| **which founding line is winning** | lab | [Lineage overlay status](#lineage-overlay-status--which-founding-line-is-taking-the-bed) 5618 |
| **putting things in the box, and what the view shows** | lab | [Lab hand-verbs status](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) 5868 |
| **the speed dial, and what a tick costs** | lab | [Lab speed-dial status](#lab-speed-dial-status--what-the-dial-is-actually-short-of) 6421 |
| **tuning and saving the box's own numbers** | lab | [Lab parameters status](#lab-parameters-status--a-save-that-reaches-the-founders-not-just-the-file) 5956 |
