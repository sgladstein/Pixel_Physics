...
Generated by `scripts/readmetoc.py` from the `##` headings — 49 of
...
|---|---|
| [Running](#running) | 142 |
| [Finding things](#finding-things) | 150 |
| [Controls](#controls) | 186 |
| [Materials](#materials) | 252 |
| [Architecture](#architecture) | 326 |
| [The coarse field grid](#the-coarse-field-grid) | 510 |
| [M12/M13 status](#m12m13-status) | 772 |
| [Liquid physics: compressible volume, not discrete occupied cells](#liquid-physics-compressible-volume-not-discrete-occupied-cells) | 799 |
| [M14 status](#m14-status) | 825 |
| [M7 status](#m7-status) | 973 |
| [M15 status](#m15-status) | 1002 |
| [M6 deferral](#m6-deferral) | 1133 |
| [M5 status](#m5-status) | 1143 |
| [Plant lines merged: the genome, and the ecology](#plant-lines-merged-the-genome-and-the-ecology) | 1238 |
| [The generation loop: plants die, seeds expire, slots come back](#the-generation-loop-plants-die-seeds-expire-slots-come-back) | 1308 |
| [The economy re-derived: standing tissue costs something](#the-economy-re-derived-standing-tissue-costs-something) | 1360 |
| [Stems draw a line: the growth walk renders its heading](#stems-draw-a-line-the-growth-walk-renders-its-heading) | 1460 |
| [Plants that stop: organs, determinacy, and a price on both](#plants-that-stop-organs-determinacy-and-a-price-on-both) | 1542 |
| [M16 status](#m16-status) | 1610 |
| [M17 status](#m17-status) | 1796 |
| [M18 status](#m18-status) | 2023 |
| [UI improvements — overnight run, section 9](#ui-improvements--overnight-run-section-9) | 2357 |
| [Live tunables panel — overnight run, section 10](#live-tunables-panel--overnight-run-section-10) | 2402 |
| [Rendering performance — overnight run, section 11](#rendering-performance--overnight-run-section-11) | 2470 |
| [M8 status — started, not complete](#m8-status--started-not-complete) | 2490 |
| [M9 status — the gnome](#m9-status--the-gnome) | 2603 |
| [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3043 |
| [Weather status](#weather-status) | 3213 |
| [The ant colony — status](#the-ant-colony--status) | 3230 |
| [Inheritance status — the growth program has no fallback under it](#inheritance-status--the-growth-program-has-no-fallback-under-it) | 3861 |
| [Parameter-genome status — a species file is a starting point, and it ships inert](#parameter-genome-status--a-species-file-is-a-starting-point-and-it-ships-inert) | 3964 |
| [M19 status — started](#m19-status--started) | 4072 |
| [Felling status — the verb works, and what it produces is pieces](#felling-status--the-verb-works-and-what-it-produces-is-pieces) | 4144 |
| [Bending status — soft tissue lies over, and the wind is what pushes it](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) | 4381 |
| [Breaking status — a badly grown tree comes down on its own](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) | 4458 |
| [Lab lighting status — the fixtures are what light the crop](#lab-lighting-status--the-fixtures-are-what-light-the-crop) | 4651 |
| [Cell page status — the specimen readout is in three groups, and folds](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) | 4778 |
| [Roster status — every plant and every animal, as a list you click through](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) | 4826 |
| [Plain-speech status — the genome read back as sentences](#plain-speech-status--the-genome-read-back-as-sentences) | 4991 |
| [Watch status — where one individual has been, and how its numbers moved](#watch-status--where-one-individual-has-been-and-how-its-numbers-moved) | 5119 |
| [Life record status — what an individual has done, and what killed it](#life-record-status--what-an-individual-has-done-and-what-killed-it) | 5184 |
| [Specimen shelf status — an individual's genetics outlive the box](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) | 5292 |
| [Lab hand-verbs status — what a click puts in the box, and what the view shows](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) | 5354 |
| [Lab parameters status — a save that reaches the founders, not just the file](#lab-parameters-status--a-save-that-reaches-the-founders-not-just-the-file) | 5442 |
| [Performance](#performance) | 5492 |
| [World speed — five independent time axes](#world-speed--five-independent-time-axes) | 5689 |
| [Status](#status) | 5772 |
| [License](#license) | 5883 |
| [Lab speed-dial status — what the dial is actually short of](#lab-speed-dial-status--what-the-dial-is-actually-short-of) | 5907 |
...
| M | Section | Line |
|---|---|---|
| 5 | [M5 status](#m5-status) | 1143 |
| 6 | [M6 deferral](#m6-deferral) | 1133 |
| 7 | [M7 status](#m7-status) | 973 |
| 8 | [M8 status — started, not complete](#m8-status--started-not-complete) | 2490 |
| 9 | [M9 status — the gnome](#m9-status--the-gnome) | 2603 |
| 10 | [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3043 |
| 12 | [M12/M13 status](#m12m13-status) | 772 |
| 14 | [M14 status](#m14-status) | 825 |
| 15 | [M15 status](#m15-status) | 1002 |
| 16 | [M16 status](#m16-status) | 1610 |
| 17 | [M17 status](#m17-status) | 1796 |
| 18 | [M18 status](#m18-status) | 2023 |
| 19 | [M19 status — started](#m19-status--started) | 4072 |
...
[Status](#status), line 5772 — the *last* section in the
...
|---|---|---|
| **plants, trees and moss** | engine | [M16 status](#m16-status) 1610, [Plant lines merged](#plant-lines-merged-the-genome-and-the-ecology) 1238, [Inheritance status](#inheritance-status--the-growth-program-has-no-fallback-under-it) 3861, [Parameter-genome status](#parameter-genome-status--a-species-file-is-a-starting-point-and-it-ships-inert) 3964, [The economy re-derived](#the-economy-re-derived-standing-tissue-costs-something) 1360, [Plants that stop](#plants-that-stop-organs-determinacy-and-a-price-on-both) 1542, [The generation loop](#the-generation-loop-plants-die-seeds-expire-slots-come-back) 1308, [Stems draw a line](#stems-draw-a-line-the-growth-walk-renders-its-heading) 1460, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 4144, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 4381, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 4458, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 5292, [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 4778, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 4826, [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 4991, [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 5184 |
| **creatures — worms and the ant colony** | engine | [M18 status](#m18-status) 2023, [The ant colony](#the-ant-colony--status) 3230, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 5292, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 4826, [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 4991, [Lab hand-verbs status](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) 5354, [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 5184 |
| **structural collapse, felling and rigid bodies** | outdoor | [M17 status](#m17-status) 1796, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 4144, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 4381, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 4458, [M8 status](#m8-status--started-not-complete) 2490 |
| **fire, heat and phase change** | engine | [M14 status](#m14-status) 825, [Materials](#materials) 252 |
| **explosions, particles and debris** | outdoor | [M15 status](#m15-status) 1002, [M7 status](#m7-status) 973 |
| **liquids and gases** | engine | [Liquid physics](#liquid-physics-compressible-volume-not-discrete-occupied-cells) 799, [The coarse field grid](#the-coarse-field-grid) 510 |
| **powders and granular flow** | engine | [Materials](#materials) 252, [Architecture](#architecture) 326 |
| **the coarse field grid — pressure, heat, light** | engine | [The coarse field grid](#the-coarse-field-grid) 510, [M12/M13 status](#m12m13-status) 772, [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 4651 |
| **worldgen and world structure** | outdoor | [M10 status](#m10-status--the-worldgen-half) 3043, [Architecture](#architecture) 326 |
| **the gnome (player character)** | outdoor | [M9 status](#m9-status--the-gnome) 2603, [Controls](#controls) 186 |
| **weather, sky and the clock** | engine | [Weather status](#weather-status) 3213, [M19 status](#m19-status--started) 4072, [World speed](#world-speed--five-independent-time-axes) 5689 |
| **rendering, UI and tunables** | engine | [UI improvements](#ui-improvements--overnight-run-section-9) 2357, [Live tunables panel](#live-tunables-panel--overnight-run-section-10) 2402, [Rendering performance](#rendering-performance--overnight-run-section-11) 2470, [M6 deferral](#m6-deferral) 1133 |
| **performance and the parallel sweep** | engine | [Performance](#performance) 5492, [M5 status](#m5-status) 1143, [Architecture](#architecture) 326, [Rendering performance](#rendering-performance--overnight-run-section-11) 2470, [Lab speed-dial status](#lab-speed-dial-status--what-the-dial-is-actually-short-of) 5907 |
| **materials and the data schema** | engine | [Materials](#materials) 252, [M12/M13 status](#m12m13-status) 772 |
| **the evolution lab — the box and its lights** | lab | [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 4651 |
| **reading one specimen off the screen** | lab | [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 4778 |
| **keeping, cloning and mutating an individual** | lab | [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 5292 |
| **finding one individual among all of them** | lab | [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 4826 |
| **the genome in plain words** | lab | [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 4991 |
| **what an individual has done, and what killed it** | lab | [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 5184 |
| **watching one individual over time** | lab | [Watch status](#watch-status--where-one-individual-has-been-and-how-its-numbers-moved) 5119 |
| **putting things in the box, and what the view shows** | lab | [Lab hand-verbs status](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) 5354 |
| **the speed dial, and what a tick costs** | lab | [Lab speed-dial status](#lab-speed-dial-status--what-the-dial-is-actually-short-of) 5907 |
| **tuning and saving the box's own numbers** | lab | [Lab parameters status](#lab-parameters-status--a-save-that-reaches-the-founders-not-just-the-file) 5442 |
