...
| [Lab soil status — a hole that stays a hole, and a bed that stops running out](#lab-soil-status--a-hole-that-stays-a-hole-and-a-bed-that-stops-running-out) | 6491 |
...
| **creatures — worms and the ant colony** | engine | [M18 status](#m18-status) 2136, [The ant colony](#the-ant-colony--status) 3343, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 5758, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 5087, [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 5318, [Lab hand-verbs status](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) 5820, [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 5650, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-and-a-bed-that-stops-running-out) 6491 |
...
| **powders and granular flow** | engine | [Materials](#materials) 257, [Architecture](#architecture) 331, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-and-a-bed-that-stops-running-out) 6491 |
...
| **the evolution lab — the box and its lights** | lab | [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 4912, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-and-a-bed-that-stops-running-out) 6491 |
