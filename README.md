...
| [Performance](#performance) | 2843 |
| [World speed — five independent time axes](#world-speed--five-independent-time-axes) | 3017 |
| [Status](#status) | 3100 |
| [License](#license) | 3211 |
...
[Status](#status), line 3100 — the *last* section in the
...
| **weather, sky and the clock** | [Weather status](#weather-status) 2660, [M19 status](#m19-status--started) 2706, [World speed](#world-speed--five-independent-time-axes) 3017 |
...
| **performance and the parallel sweep** | [Performance](#performance) 2843, [M5 status](#m5-status) 1024, [Architecture](#architecture) 293, [Rendering performance](#rendering-performance--overnight-run-section-11) 2351 |
