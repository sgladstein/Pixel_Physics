...
Generated by `scripts/readmetoc.py` from the `##` headings — 63 of
...
|---|---|
| [Running](#running) | 162 |
| [Finding things](#finding-things) | 170 |
| [Controls](#controls) | 206 |
| [Materials](#materials) | 272 |
| [Architecture](#architecture) | 346 |
| [The coarse field grid](#the-coarse-field-grid) | 533 |
| [M12/M13 status](#m12m13-status) | 795 |
| [Canopy throughfall status — rain drips through a wood](#canopy-throughfall-status--rain-drips-through-a-wood) | 822 |
| [Liquid physics: compressible volume, not discrete occupied cells](#liquid-physics-compressible-volume-not-discrete-occupied-cells) | 867 |
| [M14 status](#m14-status) | 893 |
| [M7 status](#m7-status) | 1041 |
| [M15 status](#m15-status) | 1070 |
| [M6 deferral](#m6-deferral) | 1201 |
| [M5 status](#m5-status) | 1211 |
| [Plant lines merged: the genome, and the ecology](#plant-lines-merged-the-genome-and-the-ecology) | 1306 |
| [The generation loop: plants die, seeds expire, slots come back](#the-generation-loop-plants-die-seeds-expire-slots-come-back) | 1376 |
| [The economy re-derived: standing tissue costs something](#the-economy-re-derived-standing-tissue-costs-something) | 1428 |
| [Stems draw a line: the growth walk renders its heading](#stems-draw-a-line-the-growth-walk-renders-its-heading) | 1636 |
| [Plants that stop: organs, determinacy, and a price on both](#plants-that-stop-organs-determinacy-and-a-price-on-both) | 1718 |
| [M16 status](#m16-status) | 1786 |
| [M17 status](#m17-status) | 1972 |
| [M18 status](#m18-status) | 2199 |
| [UI improvements — overnight run, section 9](#ui-improvements--overnight-run-section-9) | 2606 |
| [Live tunables panel — overnight run, section 10](#live-tunables-panel--overnight-run-section-10) | 2651 |
| [Rendering performance — overnight run, section 11](#rendering-performance--overnight-run-section-11) | 2719 |
| [M8 status — started, not complete](#m8-status--started-not-complete) | 2739 |
| [M9 status — the gnome](#m9-status--the-gnome) | 2852 |
| [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3292 |
| [Weather status](#weather-status) | 3462 |
| [The ant colony — status](#the-ant-colony--status) | 3479 |
| [Inheritance status — the growth program has no fallback under it](#inheritance-status--the-growth-program-has-no-fallback-under-it) | 4271 |
| [Parameter-genome status — a species file is a starting point, and it ships inert](#parameter-genome-status--a-species-file-is-a-starting-point-and-it-ships-inert) | 4374 |
| [M19 status — started](#m19-status--started) | 4482 |
| [Felling status — the verb works, and what it produces is pieces](#felling-status--the-verb-works-and-what-it-produces-is-pieces) | 4554 |
| [Bending status — soft tissue lies over, and the wind is what pushes it](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) | 4791 |
| [Breaking status — a badly grown tree comes down on its own](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) | 4868 |
| [Lab lighting status — the fixtures are what light the crop](#lab-lighting-status--the-fixtures-are-what-light-the-crop) | 5061 |
| [Cell page status — the specimen readout is in three groups, and folds](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) | 5188 |
| [Roster status — every plant and every animal, as a list you click through](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) | 5236 |
| [Plain-speech status — the genome read back as sentences](#plain-speech-status--the-genome-read-back-as-sentences) | 5467 |
| [Watch status — where one individual has been, and how its numbers moved](#watch-status--where-one-individual-has-been-and-how-its-numbers-moved) | 5592 |
| [Side-by-side status — two individuals, with what differs marked](#side-by-side-status--two-individuals-with-what-differs-marked) | 5657 |
| [Lineage overlay status — which founding line is taking the bed](#lineage-overlay-status--which-founding-line-is-taking-the-bed) | 5719 |
| [Creature groups status — who is who in the box, and who is family](#creature-groups-status--who-is-who-in-the-box-and-who-is-family) | 5799 |
| [Life record status — what an individual has done, and what killed it](#life-record-status--what-an-individual-has-done-and-what-killed-it) | 6221 |
| [Specimen shelf status — an individual's genetics outlive the box](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) | 6329 |
| [Lab hand-verbs status — what a click puts in the box, and what the view shows](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) | 6391 |
| [Lab parameters status — a save that reaches the founders, not just the file](#lab-parameters-status--a-save-that-reaches-the-founders-not-just-the-file) | 6479 |
| [Performance](#performance) | 6529 |
| [World speed — five independent time axes](#world-speed--five-independent-time-axes) | 6726 |
| [Status](#status) | 6809 |
| [License](#license) | 6920 |
| [Lab speed-dial status — what the dial is actually short of](#lab-speed-dial-status--what-the-dial-is-actually-short-of) | 6944 |
| [Lab scenarios status — a saved starting box with a question written on it](#lab-scenarios-status--a-saved-starting-box-with-a-question-written-on-it) | 7101 |
| [Soil nutrient status — ground is worth something water is not](#soil-nutrient-status--ground-is-worth-something-water-is-not) | 7187 |
| [Lab soil status — a hole that stays a hole anywhere in the bed, and a bed that stops running out](#lab-soil-status--a-hole-that-stays-a-hole-anywhere-in-the-bed-and-a-bed-that-stops-running-out) | 7230 |
| [Chronicle status — the box tells you who did what, at any population](#chronicle-status--the-box-tells-you-who-did-what-at-any-population) | 7387 |
| [Event reaction status — the box calls you back](#event-reaction-status--the-box-calls-you-back) | 7445 |
| [Life marks status — a pause-time mark, and what the owner rejected](#life-marks-status--a-pause-time-mark-and-what-the-owner-rejected) | 7481 |
| [Hunger status — a fed ant rests, a hungry one walks, and the founding cliff is walking cost](#hunger-status--a-fed-ant-rests-a-hungry-one-walks-and-the-founding-cliff-is-walking-cost) | 7516 |
| [Hopper status — the jump has a species, and it hops itself to death](#hopper-status--the-jump-has-a-species-and-it-hops-itself-to-death) | 7596 |
| [Creature tools status — a hand in the box: scent, alarm, fling, lamp](#creature-tools-status--a-hand-in-the-box-scent-alarm-fling-lamp) | 7627 |
| [Trophallaxis status — the colony's stomach, shipped on, and a first measurement that says wait](#trophallaxis-status--the-colonys-stomach-shipped-on-and-a-first-measurement-that-says-wait) | 7684 |
...
| M | Section | Line |
|---|---|---|
| 5 | [M5 status](#m5-status) | 1211 |
| 6 | [M6 deferral](#m6-deferral) | 1201 |
| 7 | [M7 status](#m7-status) | 1041 |
| 8 | [M8 status — started, not complete](#m8-status--started-not-complete) | 2739 |
| 9 | [M9 status — the gnome](#m9-status--the-gnome) | 2852 |
| 10 | [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3292 |
| 12 | [M12/M13 status](#m12m13-status) | 795 |
| 14 | [M14 status](#m14-status) | 893 |
| 15 | [M15 status](#m15-status) | 1070 |
| 16 | [M16 status](#m16-status) | 1786 |
| 17 | [M17 status](#m17-status) | 1972 |
| 18 | [M18 status](#m18-status) | 2199 |
| 19 | [M19 status — started](#m19-status--started) | 4482 |
...
[Status](#status), line 6809 — the *last* section in the
...
|---|---|---|
| **plants, trees and moss** | engine | [M16 status](#m16-status) 1786, [Soil nutrient status](#soil-nutrient-status--ground-is-worth-something-water-is-not) 7187, [Plant lines merged](#plant-lines-merged-the-genome-and-the-ecology) 1306, [Inheritance status](#inheritance-status--the-growth-program-has-no-fallback-under-it) 4271, [Parameter-genome status](#parameter-genome-status--a-species-file-is-a-starting-point-and-it-ships-inert) 4374, [The economy re-derived](#the-economy-re-derived-standing-tissue-costs-something) 1428, [Plants that stop](#plants-that-stop-organs-determinacy-and-a-price-on-both) 1718, [The generation loop](#the-generation-loop-plants-die-seeds-expire-slots-come-back) 1376, [Stems draw a line](#stems-draw-a-line-the-growth-walk-renders-its-heading) 1636, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 4554, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 4791, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 4868, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 6329, [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 5188, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 5236, [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 5467, [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 6221 |
| **creatures — worms and the ant colony** | engine | [M18 status](#m18-status) 2199, [The ant colony](#the-ant-colony--status) 3479, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 6329, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 5236, [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 5467, [Lab hand-verbs status](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) 6391, [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 6221, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-anywhere-in-the-bed-and-a-bed-that-stops-running-out) 7230, [Hunger status](#hunger-status--a-fed-ant-rests-a-hungry-one-walks-and-the-founding-cliff-is-walking-cost) 7516, [Hopper status](#hopper-status--the-jump-has-a-species-and-it-hops-itself-to-death) 7596, [Trophallaxis status](#trophallaxis-status--the-colonys-stomach-shipped-on-and-a-first-measurement-that-says-wait) 7684 |
| **structural collapse, felling and rigid bodies** | outdoor | [M17 status](#m17-status) 1972, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 4554, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 4791, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 4868, [M8 status](#m8-status--started-not-complete) 2739 |
| **fire, heat and phase change** | engine | [M14 status](#m14-status) 893, [Materials](#materials) 272 |
| **explosions, particles and debris** | outdoor | [M15 status](#m15-status) 1070, [M7 status](#m7-status) 1041 |
| **liquids and gases** | engine | [Liquid physics](#liquid-physics-compressible-volume-not-discrete-occupied-cells) 867, [Canopy throughfall status](#canopy-throughfall-status--rain-drips-through-a-wood) 822, [The coarse field grid](#the-coarse-field-grid) 533 |
| **powders and granular flow** | engine | [Materials](#materials) 272, [Architecture](#architecture) 346, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-anywhere-in-the-bed-and-a-bed-that-stops-running-out) 7230 |
| **the coarse field grid — pressure, heat, light** | engine | [The coarse field grid](#the-coarse-field-grid) 533, [M12/M13 status](#m12m13-status) 795, [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 5061 |
| **worldgen and world structure** | outdoor | [M10 status](#m10-status--the-worldgen-half) 3292, [Architecture](#architecture) 346 |
| **the gnome (player character)** | outdoor | [M9 status](#m9-status--the-gnome) 2852, [Controls](#controls) 206 |
| **weather, sky and the clock** | engine | [Weather status](#weather-status) 3462, [M19 status](#m19-status--started) 4482, [World speed](#world-speed--five-independent-time-axes) 6726 |
| **rendering, UI and tunables** | engine | [UI improvements](#ui-improvements--overnight-run-section-9) 2606, [Live tunables panel](#live-tunables-panel--overnight-run-section-10) 2651, [Rendering performance](#rendering-performance--overnight-run-section-11) 2719, [M6 deferral](#m6-deferral) 1201 |
| **performance and the parallel sweep** | engine | [Performance](#performance) 6529, [M5 status](#m5-status) 1211, [Architecture](#architecture) 346, [Rendering performance](#rendering-performance--overnight-run-section-11) 2719, [Lab speed-dial status](#lab-speed-dial-status--what-the-dial-is-actually-short-of) 6944 |
| **materials and the data schema** | engine | [Materials](#materials) 272, [M12/M13 status](#m12m13-status) 795 |
| **the evolution lab — the box and its lights** | lab | [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 5061, [Lab soil status](#lab-soil-status--a-hole-that-stays-a-hole-anywhere-in-the-bed-and-a-bed-that-stops-running-out) 7230 |
| **reading one specimen off the screen** | lab | [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 5188 |
| **keeping, cloning and mutating an individual** | lab | [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 6329 |
| **finding one individual among all of them** | lab | [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 5236 |
| **the genome in plain words** | lab | [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 5467 |
| **what an individual has done, and what killed it** | lab | [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 6221 |
| **watching one individual over time** | lab | [Watch status](#watch-status--where-one-individual-has-been-and-how-its-numbers-moved) 5592 |
| **comparing two individuals** | lab | [Side-by-side status](#side-by-side-status--two-individuals-with-what-differs-marked) 5657 |
| **which founding line is winning** | lab | [Lineage overlay status](#lineage-overlay-status--which-founding-line-is-taking-the-bed) 5719 |
| **who is who in the box, colonies and the rivalry rule** | lab | [Creature groups status](#creature-groups-status--who-is-who-in-the-box-and-who-is-family) 5799 |
| **putting things in the box, and what the view shows** | lab | [Lab hand-verbs status](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) 6391 |
| **the chronicle: names, line events, and a clock that reacts** | lab | [Chronicle status](#chronicle-status--the-box-tells-you-who-did-what-at-any-population) 7387, [Event reaction status](#event-reaction-status--the-box-calls-you-back) 7445, [Life marks status](#life-marks-status--a-pause-time-mark-and-what-the-owner-rejected) 7481 |
| **a hand in the box: scent, alarm, fling, lamp** | lab | [Creature tools status](#creature-tools-status--a-hand-in-the-box-scent-alarm-fling-lamp) 7627 |
| **the speed dial, and what a tick costs** | lab | [Lab speed-dial status](#lab-speed-dial-status--what-the-dial-is-actually-short-of) 6944 |
| **tuning and saving the box's own numbers** | lab | [Lab parameters status](#lab-parameters-status--a-save-that-reaches-the-founders-not-just-the-file) 6479 |
| **a saved starting box, and replicating it in a rack** | lab | [Lab scenarios status](#lab-scenarios-status--a-saved-starting-box-with-a-question-written-on-it) 7101 |
...
About a third of drip attempts still find no air within the 16-cell reach
inside a dense crown, which is what leaves the small residue. Stemflow —
water running down a trunk — does not exist.
`Reports/canopy-throughfall-2026-09-07.md`.
...
**A bias of 2.0 on the jump is a hop on two ticks in three, and it kills
the animal in a session.** That is the movement report's own measured
trade (a hopper covers twice the ground and pays in bodies) at a rate no
frog keeps, and it is the creature line's to set — a jump gated on hunger
the way the walk now is, or on a trail, is one line, and picking it is a
paired measurement, not a coordinator's taste. Recorded here rather than
tuned.
...
**The first measurement of sharing is a null with a warning sign, and it
is on the page rather than under it.** Same bed, same seeds, `labforage
frames=6000`, survivors at 6,000 and harvested J:

| | seed 1 | seed 2 | seed 3 | mean alive | mean intake |
|---|---|---|---|---|---|
| sharing off | 15 / 3,534 | 18 / 3,852 | 14 / 3,990 | 15.7 | 3,792 |
| sharing on | 0 / 570 | 5 / 2,622 | 19 / 4,560 | 8.0 | 2,584 |

The mechanism fires — 170–276 shares and 2,100–3,700 J moved per run,
zero with the switch off — sharing is *not* exclusive with moving or eating
(checked in `act` and by two variants, one non-exclusive, one with a
30-tick cooldown, neither outside the shipped arm's own spread), and a
worktree-only `(KinNeed, Move, +1.25)` arm did worse still. On two seeds of
three the sharing colony ends with fewer than half the survivors; the
third does better; the spread within one arm runs eight-fold, so three
seeds cannot sign it. **And sharing undoes the stagger**: with both on,
survivors fall back to 8.0, because sharing flows down the energy gradient
and the stagger *is* an energy gradient. What decides it is the played
bed, six seeds or more, 30,000 frames, with the composed Move row — and
until that is run, this section says so rather than claiming the colony
shares its way past the cliff.
