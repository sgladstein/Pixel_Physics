...
| [Felling status — the verb works, and what it produces is pieces](#felling-status--the-verb-works-and-what-it-produces-is-pieces) | 3596 |
| [Bending status — soft tissue lies over, and the wind is what pushes it](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) | 3833 |
| [Breaking status — a badly grown tree comes down on its own](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) | 3910 |
| [Performance](#performance) | 4036 |
| [World speed — five independent time axes](#world-speed--five-independent-time-axes) | 4233 |
| [Status](#status) | 4316 |
| [License](#license) | 4427 |
...
[Status](#status), line 4316 — the *last* section in the
...
| **weather, sky and the clock** | engine | [Weather status](#weather-status) 3183, [M19 status](#m19-status--started) 3520, [World speed](#world-speed--five-independent-time-axes) 4233 |
...
| **performance and the parallel sweep** | engine | [Performance](#performance) 4036, [M5 status](#m5-status) 1113, [Architecture](#architecture) 305, [Rendering performance](#rendering-performance--overnight-run-section-11) 2440 |
