...
Generated by `scripts/readmetoc.py` from the `##` headings — 41 of
...
|---|---|
| [Running](#running) | 127 |
| [Finding things](#finding-things) | 135 |
| [Controls](#controls) | 171 |
| [Materials](#materials) | 237 |
| [Architecture](#architecture) | 311 |
| [The coarse field grid](#the-coarse-field-grid) | 495 |
| [M12/M13 status](#m12m13-status) | 757 |
| [Liquid physics: compressible volume, not discrete occupied cells](#liquid-physics-compressible-volume-not-discrete-occupied-cells) | 784 |
| [M14 status](#m14-status) | 810 |
| [M7 status](#m7-status) | 958 |
| [M15 status](#m15-status) | 987 |
| [M6 deferral](#m6-deferral) | 1118 |
| [M5 status](#m5-status) | 1128 |
| [Plant lines merged: the genome, and the ecology](#plant-lines-merged-the-genome-and-the-ecology) | 1223 |
| [The generation loop: plants die, seeds expire, slots come back](#the-generation-loop-plants-die-seeds-expire-slots-come-back) | 1293 |
| [The economy re-derived: standing tissue costs something](#the-economy-re-derived-standing-tissue-costs-something) | 1345 |
| [Stems draw a line: the growth walk renders its heading](#stems-draw-a-line-the-growth-walk-renders-its-heading) | 1445 |
| [Plants that stop: organs, determinacy, and a price on both](#plants-that-stop-organs-determinacy-and-a-price-on-both) | 1527 |
| [M16 status](#m16-status) | 1595 |
| [M17 status](#m17-status) | 1781 |
| [M18 status](#m18-status) | 2008 |
| [UI improvements — overnight run, section 9](#ui-improvements--overnight-run-section-9) | 2342 |
| [Live tunables panel — overnight run, section 10](#live-tunables-panel--overnight-run-section-10) | 2387 |
| [Rendering performance — overnight run, section 11](#rendering-performance--overnight-run-section-11) | 2455 |
| [M8 status — started, not complete](#m8-status--started-not-complete) | 2475 |
| [M9 status — the gnome](#m9-status--the-gnome) | 2588 |
| [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3028 |
| [Weather status](#weather-status) | 3198 |
| [The ant colony — status](#the-ant-colony--status) | 3215 |
| [Inheritance status — the growth program has no fallback under it](#inheritance-status--the-growth-program-has-no-fallback-under-it) | 3573 |
| [M19 status — started](#m19-status--started) | 3676 |
| [Felling status — the verb works, and what it produces is pieces](#felling-status--the-verb-works-and-what-it-produces-is-pieces) | 3748 |
| [Bending status — soft tissue lies over, and the wind is what pushes it](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) | 3985 |
| [Breaking status — a badly grown tree comes down on its own](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) | 4062 |
| [Lab lighting status — the fixtures are what light the crop](#lab-lighting-status--the-fixtures-are-what-light-the-crop) | 4255 |
| [Cell page status — the specimen readout is in three groups, and folds](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) | 4317 |
| [Specimen shelf status — an individual's genetics outlive the box](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) | 4365 |
| [Performance](#performance) | 4427 |
| [World speed — five independent time axes](#world-speed--five-independent-time-axes) | 4624 |
| [Status](#status) | 4707 |
| [License](#license) | 4818 |
...
| M | Section | Line |
|---|---|---|
| 5 | [M5 status](#m5-status) | 1128 |
| 6 | [M6 deferral](#m6-deferral) | 1118 |
| 7 | [M7 status](#m7-status) | 958 |
| 8 | [M8 status — started, not complete](#m8-status--started-not-complete) | 2475 |
| 9 | [M9 status — the gnome](#m9-status--the-gnome) | 2588 |
| 10 | [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3028 |
| 12 | [M12/M13 status](#m12m13-status) | 757 |
| 14 | [M14 status](#m14-status) | 810 |
| 15 | [M15 status](#m15-status) | 987 |
| 16 | [M16 status](#m16-status) | 1595 |
| 17 | [M17 status](#m17-status) | 1781 |
| 18 | [M18 status](#m18-status) | 2008 |
| 19 | [M19 status — started](#m19-status--started) | 3676 |
...
[Status](#status), line 4707 — the *last* section in the
...
|---|---|---|
| **plants, trees and moss** | engine | [M16 status](#m16-status) 1595, [Plant lines merged](#plant-lines-merged-the-genome-and-the-ecology) 1223, [Inheritance status](#inheritance-status--the-growth-program-has-no-fallback-under-it) 3573, [The economy re-derived](#the-economy-re-derived-standing-tissue-costs-something) 1345, [Plants that stop](#plants-that-stop-organs-determinacy-and-a-price-on-both) 1527, [The generation loop](#the-generation-loop-plants-die-seeds-expire-slots-come-back) 1293, [Stems draw a line](#stems-draw-a-line-the-growth-walk-renders-its-heading) 1445, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 3748, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 3985, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 4062, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 4365, [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 4317 |
| **creatures — worms and the ant colony** | engine | [M18 status](#m18-status) 2008, [The ant colony](#the-ant-colony--status) 3215, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 4365 |
| **structural collapse, felling and rigid bodies** | outdoor | [M17 status](#m17-status) 1781, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 3748, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 3985, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 4062, [M8 status](#m8-status--started-not-complete) 2475 |
| **fire, heat and phase change** | engine | [M14 status](#m14-status) 810, [Materials](#materials) 237 |
| **explosions, particles and debris** | outdoor | [M15 status](#m15-status) 987, [M7 status](#m7-status) 958 |
| **liquids and gases** | engine | [Liquid physics](#liquid-physics-compressible-volume-not-discrete-occupied-cells) 784, [The coarse field grid](#the-coarse-field-grid) 495 |
| **powders and granular flow** | engine | [Materials](#materials) 237, [Architecture](#architecture) 311 |
| **the coarse field grid — pressure, heat, light** | engine | [The coarse field grid](#the-coarse-field-grid) 495, [M12/M13 status](#m12m13-status) 757, [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 4255 |
| **worldgen and world structure** | outdoor | [M10 status](#m10-status--the-worldgen-half) 3028, [Architecture](#architecture) 311 |
| **the gnome (player character)** | outdoor | [M9 status](#m9-status--the-gnome) 2588, [Controls](#controls) 171 |
| **weather, sky and the clock** | engine | [Weather status](#weather-status) 3198, [M19 status](#m19-status--started) 3676, [World speed](#world-speed--five-independent-time-axes) 4624 |
| **rendering, UI and tunables** | engine | [UI improvements](#ui-improvements--overnight-run-section-9) 2342, [Live tunables panel](#live-tunables-panel--overnight-run-section-10) 2387, [Rendering performance](#rendering-performance--overnight-run-section-11) 2455, [M6 deferral](#m6-deferral) 1118 |
| **performance and the parallel sweep** | engine | [Performance](#performance) 4427, [M5 status](#m5-status) 1128, [Architecture](#architecture) 311, [Rendering performance](#rendering-performance--overnight-run-section-11) 2455 |
| **materials and the data schema** | engine | [Materials](#materials) 237, [M12/M13 status](#m12m13-status) 757 |
| **the evolution lab — the box and its lights** | lab | [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 4255 |
| **reading one specimen off the screen** | lab | [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 4317 |
| **keeping, cloning and mutating an individual** | lab | [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 4365 |
