...
| `B` | Toggle whether the brush lays **background** rock (terrain, braced by the mass behind the slice — behaves like a cliff) or **foreground** (default — must hold itself up, so building is a real constraint) |
