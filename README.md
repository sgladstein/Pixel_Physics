...
Generated by `scripts/readmetoc.py` from the `##` headings — 50 of
...
|---|---|
| [Running](#running) | 144 |
| [Finding things](#finding-things) | 152 |
| [Controls](#controls) | 188 |
| [Materials](#materials) | 254 |
| [Architecture](#architecture) | 328 |
| [The coarse field grid](#the-coarse-field-grid) | 512 |
| [M12/M13 status](#m12m13-status) | 774 |
| [Liquid physics: compressible volume, not discrete occupied cells](#liquid-physics-compressible-volume-not-discrete-occupied-cells) | 801 |
| [M14 status](#m14-status) | 827 |
| [M7 status](#m7-status) | 975 |
| [M15 status](#m15-status) | 1004 |
| [M6 deferral](#m6-deferral) | 1135 |
| [M5 status](#m5-status) | 1145 |
| [Plant lines merged: the genome, and the ecology](#plant-lines-merged-the-genome-and-the-ecology) | 1240 |
| [The generation loop: plants die, seeds expire, slots come back](#the-generation-loop-plants-die-seeds-expire-slots-come-back) | 1310 |
| [The economy re-derived: standing tissue costs something](#the-economy-re-derived-standing-tissue-costs-something) | 1362 |
| [Stems draw a line: the growth walk renders its heading](#stems-draw-a-line-the-growth-walk-renders-its-heading) | 1570 |
| [Plants that stop: organs, determinacy, and a price on both](#plants-that-stop-organs-determinacy-and-a-price-on-both) | 1652 |
| [M16 status](#m16-status) | 1720 |
| [M17 status](#m17-status) | 1906 |
| [M18 status](#m18-status) | 2133 |
| [UI improvements — overnight run, section 9](#ui-improvements--overnight-run-section-9) | 2467 |
| [Live tunables panel — overnight run, section 10](#live-tunables-panel--overnight-run-section-10) | 2512 |
| [Rendering performance — overnight run, section 11](#rendering-performance--overnight-run-section-11) | 2580 |
| [M8 status — started, not complete](#m8-status--started-not-complete) | 2600 |
| [M9 status — the gnome](#m9-status--the-gnome) | 2713 |
| [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3153 |
| [Weather status](#weather-status) | 3323 |
| [The ant colony — status](#the-ant-colony--status) | 3340 |
| [Inheritance status — the growth program has no fallback under it](#inheritance-status--the-growth-program-has-no-fallback-under-it) | 4119 |
| [Parameter-genome status — a species file is a starting point, and it ships inert](#parameter-genome-status--a-species-file-is-a-starting-point-and-it-ships-inert) | 4222 |
| [M19 status — started](#m19-status--started) | 4330 |
| [Felling status — the verb works, and what it produces is pieces](#felling-status--the-verb-works-and-what-it-produces-is-pieces) | 4402 |
| [Bending status — soft tissue lies over, and the wind is what pushes it](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) | 4639 |
| [Breaking status — a badly grown tree comes down on its own](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) | 4716 |
| [Lab lighting status — the fixtures are what light the crop](#lab-lighting-status--the-fixtures-are-what-light-the-crop) | 4909 |
| [Cell page status — the specimen readout is in three groups, and folds](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) | 5036 |
| [Roster status — every plant and every animal, as a list you click through](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) | 5084 |
| [Plain-speech status — the genome read back as sentences](#plain-speech-status--the-genome-read-back-as-sentences) | 5315 |
| [Watch status — where one individual has been, and how its numbers moved](#watch-status--where-one-individual-has-been-and-how-its-numbers-moved) | 5440 |
| [Side-by-side status — two individuals, with what differs marked](#side-by-side-status--two-individuals-with-what-differs-marked) | 5505 |
| [Life record status — what an individual has done, and what killed it](#life-record-status--what-an-individual-has-done-and-what-killed-it) | 5567 |
| [Specimen shelf status — an individual's genetics outlive the box](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) | 5675 |
| [Lab hand-verbs status — what a click puts in the box, and what the view shows](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) | 5737 |
| [Lab parameters status — a save that reaches the founders, not just the file](#lab-parameters-status--a-save-that-reaches-the-founders-not-just-the-file) | 5825 |
| [Performance](#performance) | 5875 |
| [World speed — five independent time axes](#world-speed--five-independent-time-axes) | 6072 |
| [Status](#status) | 6155 |
| [License](#license) | 6266 |
| [Lab speed-dial status — what the dial is actually short of](#lab-speed-dial-status--what-the-dial-is-actually-short-of) | 6290 |
...
| M | Section | Line |
|---|---|---|
| 5 | [M5 status](#m5-status) | 1145 |
| 6 | [M6 deferral](#m6-deferral) | 1135 |
| 7 | [M7 status](#m7-status) | 975 |
| 8 | [M8 status — started, not complete](#m8-status--started-not-complete) | 2600 |
| 9 | [M9 status — the gnome](#m9-status--the-gnome) | 2713 |
| 10 | [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3153 |
| 12 | [M12/M13 status](#m12m13-status) | 774 |
| 14 | [M14 status](#m14-status) | 827 |
| 15 | [M15 status](#m15-status) | 1004 |
| 16 | [M16 status](#m16-status) | 1720 |
| 17 | [M17 status](#m17-status) | 1906 |
| 18 | [M18 status](#m18-status) | 2133 |
| 19 | [M19 status — started](#m19-status--started) | 4330 |
...
[Status](#status), line 6155 — the *last* section in the
...
|---|---|---|
| **plants, trees and moss** | engine | [M16 status](#m16-status) 1720, [Plant lines merged](#plant-lines-merged-the-genome-and-the-ecology) 1240, [Inheritance status](#inheritance-status--the-growth-program-has-no-fallback-under-it) 4119, [Parameter-genome status](#parameter-genome-status--a-species-file-is-a-starting-point-and-it-ships-inert) 4222, [The economy re-derived](#the-economy-re-derived-standing-tissue-costs-something) 1362, [Plants that stop](#plants-that-stop-organs-determinacy-and-a-price-on-both) 1652, [The generation loop](#the-generation-loop-plants-die-seeds-expire-slots-come-back) 1310, [Stems draw a line](#stems-draw-a-line-the-growth-walk-renders-its-heading) 1570, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 4402, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 4639, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 4716, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 5675, [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 5036, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 5084, [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 5315, [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 5567 |
| **creatures — worms and the ant colony** | engine | [M18 status](#m18-status) 2133, [The ant colony](#the-ant-colony--status) 3340, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 5675, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 5084, [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 5315, [Lab hand-verbs status](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) 5737, [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 5567 |
| **structural collapse, felling and rigid bodies** | outdoor | [M17 status](#m17-status) 1906, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 4402, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 4639, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 4716, [M8 status](#m8-status--started-not-complete) 2600 |
...
| **liquids and gases** | engine | [Liquid physics](#liquid-physics-compressible-volume-not-discrete-occupied-cells) 801, [The coarse field grid](#the-coarse-field-grid) 512 |
| **powders and granular flow** | engine | [Materials](#materials) 254, [Architecture](#architecture) 328 |
| **the coarse field grid — pressure, heat, light** | engine | [The coarse field grid](#the-coarse-field-grid) 512, [M12/M13 status](#m12m13-status) 774, [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 4909 |
| **worldgen and world structure** | outdoor | [M10 status](#m10-status--the-worldgen-half) 3153, [Architecture](#architecture) 328 |
| **the gnome (player character)** | outdoor | [M9 status](#m9-status--the-gnome) 2713, [Controls](#controls) 188 |
| **weather, sky and the clock** | engine | [Weather status](#weather-status) 3323, [M19 status](#m19-status--started) 4330, [World speed](#world-speed--five-independent-time-axes) 6072 |
| **rendering, UI and tunables** | engine | [UI improvements](#ui-improvements--overnight-run-section-9) 2467, [Live tunables panel](#live-tunables-panel--overnight-run-section-10) 2512, [Rendering performance](#rendering-performance--overnight-run-section-11) 2580, [M6 deferral](#m6-deferral) 1135 |
| **performance and the parallel sweep** | engine | [Performance](#performance) 5875, [M5 status](#m5-status) 1145, [Architecture](#architecture) 328, [Rendering performance](#rendering-performance--overnight-run-section-11) 2580, [Lab speed-dial status](#lab-speed-dial-status--what-the-dial-is-actually-short-of) 6290 |
| **materials and the data schema** | engine | [Materials](#materials) 254, [M12/M13 status](#m12m13-status) 774 |
| **the evolution lab — the box and its lights** | lab | [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 4909 |
| **reading one specimen off the screen** | lab | [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 5036 |
| **keeping, cloning and mutating an individual** | lab | [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 5675 |
| **finding one individual among all of them** | lab | [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 5084 |
| **the genome in plain words** | lab | [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 5315 |
| **what an individual has done, and what killed it** | lab | [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 5567 |
| **watching one individual over time** | lab | [Watch status](#watch-status--where-one-individual-has-been-and-how-its-numbers-moved) 5440 |
| **comparing two individuals** | lab | [Side-by-side status](#side-by-side-status--two-individuals-with-what-differs-marked) 5505 |
| **putting things in the box, and what the view shows** | lab | [Lab hand-verbs status](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) 5737 |
| **the speed dial, and what a tick costs** | lab | [Lab speed-dial status](#lab-speed-dial-status--what-the-dial-is-actually-short-of) 6290 |
| **tuning and saving the box's own numbers** | lab | [Lab parameters status](#lab-parameters-status--a-save-that-reaches-the-founders-not-just-the-file) 5825 |
...
**Not built yet.** The lineage overlay — colouring the box by founding line —
is the other half of PR 4 and is not here.
