...
| [M19 status — started](#m19-status--started) | 3200 |
| [Felling status — the verb works, and what it produces is pieces](#felling-status--the-verb-works-and-what-it-produces-is-pieces) | 3272 |
| [Bending status — soft tissue lies over, and the wind is what pushes it](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) | 3509 |
| [Breaking status — a badly grown tree comes down on its own](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) | 3586 |
| [Performance](#performance) | 3678 |
| [World speed — five independent time axes](#world-speed--five-independent-time-axes) | 3875 |
| [Status](#status) | 3958 |
| [License](#license) | 4069 |
...
| 19 | [M19 status — started](#m19-status--started) | 3200 |
...
[Status](#status), line 3958 — the *last* section in the
file, not the first. Read it before concluding something is broken.

| Topic | Sections, primary first |
|---|---|
| **plants, trees and moss** | [M16 status](#m16-status) 1555, [Plant lines merged](#plant-lines-merged-the-genome-and-the-ecology) 1183, [The economy re-derived](#the-economy-re-derived-standing-tissue-costs-something) 1305, [Plants that stop](#plants-that-stop-organs-determinacy-and-a-price-on-both) 1487, [The generation loop](#the-generation-loop-plants-die-seeds-expire-slots-come-back) 1253, [Stems draw a line](#stems-draw-a-line-the-growth-walk-renders-its-heading) 1405, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 3272, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 3509, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 3586 |
| **creatures — worms and the ant colony** | [M18 status](#m18-status) 1968, [The ant colony](#the-ant-colony--status) 3065 |
| **structural collapse, felling and rigid bodies** | [M17 status](#m17-status) 1741, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 3272, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 3509, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 3586, [M8 status](#m8-status--started-not-complete) 2435 |
...
| **the gnome (player character)** | [M9 status](#m9-status--the-gnome) 2548, [Controls](#controls) 158 |
| **weather, sky and the clock** | [Weather status](#weather-status) 3048, [M19 status](#m19-status--started) 3200, [World speed](#world-speed--five-independent-time-axes) 3875 |
...
| **performance and the parallel sweep** | [Performance](#performance) 3678, [M5 status](#m5-status) 1088, [Architecture](#architecture) 298, [Rendering performance](#rendering-performance--overnight-run-section-11) 2415 |
