...
Generated by `scripts/readmetoc.py` from the `##` headings — 48 of
...
|---|---|
| [Running](#running) | 140 |
| [Finding things](#finding-things) | 148 |
| [Controls](#controls) | 184 |
| [Materials](#materials) | 250 |
| [Architecture](#architecture) | 324 |
| [The coarse field grid](#the-coarse-field-grid) | 508 |
| [M12/M13 status](#m12m13-status) | 770 |
| [Liquid physics: compressible volume, not discrete occupied cells](#liquid-physics-compressible-volume-not-discrete-occupied-cells) | 797 |
| [M14 status](#m14-status) | 823 |
| [M7 status](#m7-status) | 971 |
| [M15 status](#m15-status) | 1000 |
| [M6 deferral](#m6-deferral) | 1131 |
| [M5 status](#m5-status) | 1141 |
| [Plant lines merged: the genome, and the ecology](#plant-lines-merged-the-genome-and-the-ecology) | 1236 |
| [The generation loop: plants die, seeds expire, slots come back](#the-generation-loop-plants-die-seeds-expire-slots-come-back) | 1306 |
| [The economy re-derived: standing tissue costs something](#the-economy-re-derived-standing-tissue-costs-something) | 1358 |
| [Stems draw a line: the growth walk renders its heading](#stems-draw-a-line-the-growth-walk-renders-its-heading) | 1458 |
| [Plants that stop: organs, determinacy, and a price on both](#plants-that-stop-organs-determinacy-and-a-price-on-both) | 1540 |
| [M16 status](#m16-status) | 1608 |
| [M17 status](#m17-status) | 1794 |
| [M18 status](#m18-status) | 2021 |
| [UI improvements — overnight run, section 9](#ui-improvements--overnight-run-section-9) | 2355 |
| [Live tunables panel — overnight run, section 10](#live-tunables-panel--overnight-run-section-10) | 2400 |
| [Rendering performance — overnight run, section 11](#rendering-performance--overnight-run-section-11) | 2468 |
| [M8 status — started, not complete](#m8-status--started-not-complete) | 2488 |
| [M9 status — the gnome](#m9-status--the-gnome) | 2601 |
| [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3041 |
| [Weather status](#weather-status) | 3211 |
| [The ant colony — status](#the-ant-colony--status) | 3228 |
| [Inheritance status — the growth program has no fallback under it](#inheritance-status--the-growth-program-has-no-fallback-under-it) | 3859 |
| [Parameter-genome status — a species file is a starting point, and it ships inert](#parameter-genome-status--a-species-file-is-a-starting-point-and-it-ships-inert) | 3962 |
| [M19 status — started](#m19-status--started) | 4070 |
| [Felling status — the verb works, and what it produces is pieces](#felling-status--the-verb-works-and-what-it-produces-is-pieces) | 4142 |
| [Bending status — soft tissue lies over, and the wind is what pushes it](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) | 4379 |
| [Breaking status — a badly grown tree comes down on its own](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) | 4456 |
| [Lab lighting status — the fixtures are what light the crop](#lab-lighting-status--the-fixtures-are-what-light-the-crop) | 4649 |
| [Cell page status — the specimen readout is in three groups, and folds](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) | 4776 |
| [Roster status — every plant and every animal, as a list you click through](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) | 4824 |
| [Plain-speech status — the genome read back as sentences](#plain-speech-status--the-genome-read-back-as-sentences) | 4989 |
| [Life record status — what an individual has done, and what killed it](#life-record-status--what-an-individual-has-done-and-what-killed-it) | 5117 |
| [Specimen shelf status — an individual's genetics outlive the box](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) | 5225 |
| [Lab hand-verbs status — what a click puts in the box, and what the view shows](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) | 5287 |
| [Lab parameters status — a save that reaches the founders, not just the file](#lab-parameters-status--a-save-that-reaches-the-founders-not-just-the-file) | 5375 |
| [Performance](#performance) | 5425 |
| [World speed — five independent time axes](#world-speed--five-independent-time-axes) | 5622 |
| [Status](#status) | 5705 |
| [License](#license) | 5816 |
| [Lab speed-dial status — what the dial is actually short of](#lab-speed-dial-status--what-the-dial-is-actually-short-of) | 5840 |
...
| M | Section | Line |
|---|---|---|
| 5 | [M5 status](#m5-status) | 1141 |
| 6 | [M6 deferral](#m6-deferral) | 1131 |
| 7 | [M7 status](#m7-status) | 971 |
| 8 | [M8 status — started, not complete](#m8-status--started-not-complete) | 2488 |
| 9 | [M9 status — the gnome](#m9-status--the-gnome) | 2601 |
| 10 | [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3041 |
| 12 | [M12/M13 status](#m12m13-status) | 770 |
| 14 | [M14 status](#m14-status) | 823 |
| 15 | [M15 status](#m15-status) | 1000 |
| 16 | [M16 status](#m16-status) | 1608 |
| 17 | [M17 status](#m17-status) | 1794 |
| 18 | [M18 status](#m18-status) | 2021 |
| 19 | [M19 status — started](#m19-status--started) | 4070 |
...
[Status](#status), line 5705 — the *last* section in the
...
|---|---|---|
| **plants, trees and moss** | engine | [M16 status](#m16-status) 1608, [Plant lines merged](#plant-lines-merged-the-genome-and-the-ecology) 1236, [Inheritance status](#inheritance-status--the-growth-program-has-no-fallback-under-it) 3859, [Parameter-genome status](#parameter-genome-status--a-species-file-is-a-starting-point-and-it-ships-inert) 3962, [The economy re-derived](#the-economy-re-derived-standing-tissue-costs-something) 1358, [Plants that stop](#plants-that-stop-organs-determinacy-and-a-price-on-both) 1540, [The generation loop](#the-generation-loop-plants-die-seeds-expire-slots-come-back) 1306, [Stems draw a line](#stems-draw-a-line-the-growth-walk-renders-its-heading) 1458, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 4142, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 4379, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 4456, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 5225, [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 4776, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 4824, [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 4989, [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 5117 |
| **creatures — worms and the ant colony** | engine | [M18 status](#m18-status) 2021, [The ant colony](#the-ant-colony--status) 3228, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 5225, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 4824, [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 4989, [Lab hand-verbs status](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) 5287, [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 5117 |
| **structural collapse, felling and rigid bodies** | outdoor | [M17 status](#m17-status) 1794, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 4142, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 4379, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 4456, [M8 status](#m8-status--started-not-complete) 2488 |
| **fire, heat and phase change** | engine | [M14 status](#m14-status) 823, [Materials](#materials) 250 |
| **explosions, particles and debris** | outdoor | [M15 status](#m15-status) 1000, [M7 status](#m7-status) 971 |
| **liquids and gases** | engine | [Liquid physics](#liquid-physics-compressible-volume-not-discrete-occupied-cells) 797, [The coarse field grid](#the-coarse-field-grid) 508 |
| **powders and granular flow** | engine | [Materials](#materials) 250, [Architecture](#architecture) 324 |
| **the coarse field grid — pressure, heat, light** | engine | [The coarse field grid](#the-coarse-field-grid) 508, [M12/M13 status](#m12m13-status) 770, [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 4649 |
| **worldgen and world structure** | outdoor | [M10 status](#m10-status--the-worldgen-half) 3041, [Architecture](#architecture) 324 |
| **the gnome (player character)** | outdoor | [M9 status](#m9-status--the-gnome) 2601, [Controls](#controls) 184 |
| **weather, sky and the clock** | engine | [Weather status](#weather-status) 3211, [M19 status](#m19-status--started) 4070, [World speed](#world-speed--five-independent-time-axes) 5622 |
| **rendering, UI and tunables** | engine | [UI improvements](#ui-improvements--overnight-run-section-9) 2355, [Live tunables panel](#live-tunables-panel--overnight-run-section-10) 2400, [Rendering performance](#rendering-performance--overnight-run-section-11) 2468, [M6 deferral](#m6-deferral) 1131 |
| **performance and the parallel sweep** | engine | [Performance](#performance) 5425, [M5 status](#m5-status) 1141, [Architecture](#architecture) 324, [Rendering performance](#rendering-performance--overnight-run-section-11) 2468, [Lab speed-dial status](#lab-speed-dial-status--what-the-dial-is-actually-short-of) 5840 |
| **materials and the data schema** | engine | [Materials](#materials) 250, [M12/M13 status](#m12m13-status) 770 |
| **the evolution lab — the box and its lights** | lab | [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 4649 |
| **reading one specimen off the screen** | lab | [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 4776 |
| **keeping, cloning and mutating an individual** | lab | [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 5225 |
| **finding one individual among all of them** | lab | [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 4824 |
| **the genome in plain words** | lab | [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 4989 |
| **what an individual has done, and what killed it** | lab | [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 5117 |
| **putting things in the box, and what the view shows** | lab | [Lab hand-verbs status](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) 5287 |
| **the speed dial, and what a tick costs** | lab | [Lab speed-dial status](#lab-speed-dial-status--what-the-dial-is-actually-short-of) 5840 |
| **tuning and saving the box's own numbers** | lab | [Lab parameters status](#lab-parameters-status--a-save-that-reaches-the-founders-not-just-the-file) 5375 |
