...
Generated by `scripts/readmetoc.py` from the `##` headings — 46 of
...
|---|---|
| [Running](#running) | 137 |
| [Finding things](#finding-things) | 145 |
| [Controls](#controls) | 181 |
| [Materials](#materials) | 247 |
| [Architecture](#architecture) | 321 |
| [The coarse field grid](#the-coarse-field-grid) | 505 |
| [M12/M13 status](#m12m13-status) | 767 |
| [Liquid physics: compressible volume, not discrete occupied cells](#liquid-physics-compressible-volume-not-discrete-occupied-cells) | 794 |
| [M14 status](#m14-status) | 820 |
| [M7 status](#m7-status) | 968 |
| [M15 status](#m15-status) | 997 |
| [M6 deferral](#m6-deferral) | 1128 |
| [M5 status](#m5-status) | 1138 |
| [Plant lines merged: the genome, and the ecology](#plant-lines-merged-the-genome-and-the-ecology) | 1233 |
| [The generation loop: plants die, seeds expire, slots come back](#the-generation-loop-plants-die-seeds-expire-slots-come-back) | 1303 |
| [The economy re-derived: standing tissue costs something](#the-economy-re-derived-standing-tissue-costs-something) | 1355 |
| [Stems draw a line: the growth walk renders its heading](#stems-draw-a-line-the-growth-walk-renders-its-heading) | 1455 |
| [Plants that stop: organs, determinacy, and a price on both](#plants-that-stop-organs-determinacy-and-a-price-on-both) | 1537 |
| [M16 status](#m16-status) | 1605 |
| [M17 status](#m17-status) | 1791 |
| [M18 status](#m18-status) | 2018 |
| [UI improvements — overnight run, section 9](#ui-improvements--overnight-run-section-9) | 2352 |
| [Live tunables panel — overnight run, section 10](#live-tunables-panel--overnight-run-section-10) | 2397 |
| [Rendering performance — overnight run, section 11](#rendering-performance--overnight-run-section-11) | 2465 |
| [M8 status — started, not complete](#m8-status--started-not-complete) | 2485 |
| [M9 status — the gnome](#m9-status--the-gnome) | 2598 |
| [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3038 |
| [Weather status](#weather-status) | 3208 |
| [The ant colony — status](#the-ant-colony--status) | 3225 |
| [Inheritance status — the growth program has no fallback under it](#inheritance-status--the-growth-program-has-no-fallback-under-it) | 3583 |
| [M19 status — started](#m19-status--started) | 3686 |
| [Felling status — the verb works, and what it produces is pieces](#felling-status--the-verb-works-and-what-it-produces-is-pieces) | 3758 |
| [Bending status — soft tissue lies over, and the wind is what pushes it](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) | 3995 |
| [Breaking status — a badly grown tree comes down on its own](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) | 4072 |
| [Lab lighting status — the fixtures are what light the crop](#lab-lighting-status--the-fixtures-are-what-light-the-crop) | 4265 |
| [Cell page status — the specimen readout is in three groups, and folds](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) | 4327 |
| [Roster status — every plant and every animal, as a list you click through](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) | 4375 |
| [Plain-speech status — the genome read back as sentences](#plain-speech-status--the-genome-read-back-as-sentences) | 4477 |
| [Life record status — what an individual has done, and what killed it](#life-record-status--what-an-individual-has-done-and-what-killed-it) | 4579 |
| [Specimen shelf status — an individual's genetics outlive the box](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) | 4687 |
| [Lab hand-verbs status — what a click puts in the box, and what the view shows](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) | 4749 |
| [Performance](#performance) | 4837 |
| [World speed — five independent time axes](#world-speed--five-independent-time-axes) | 5034 |
| [Status](#status) | 5117 |
| [License](#license) | 5228 |
| [Lab speed-dial status — what the dial is actually short of](#lab-speed-dial-status--what-the-dial-is-actually-short-of) | 5252 |
...
| M | Section | Line |
|---|---|---|
| 5 | [M5 status](#m5-status) | 1138 |
| 6 | [M6 deferral](#m6-deferral) | 1128 |
| 7 | [M7 status](#m7-status) | 968 |
| 8 | [M8 status — started, not complete](#m8-status--started-not-complete) | 2485 |
| 9 | [M9 status — the gnome](#m9-status--the-gnome) | 2598 |
| 10 | [M10 status — the worldgen half](#m10-status--the-worldgen-half) | 3038 |
| 12 | [M12/M13 status](#m12m13-status) | 767 |
| 14 | [M14 status](#m14-status) | 820 |
| 15 | [M15 status](#m15-status) | 997 |
| 16 | [M16 status](#m16-status) | 1605 |
| 17 | [M17 status](#m17-status) | 1791 |
| 18 | [M18 status](#m18-status) | 2018 |
| 19 | [M19 status — started](#m19-status--started) | 3686 |
...
[Status](#status), line 5117 — the *last* section in the
...
|---|---|---|
| **plants, trees and moss** | engine | [M16 status](#m16-status) 1605, [Plant lines merged](#plant-lines-merged-the-genome-and-the-ecology) 1233, [Inheritance status](#inheritance-status--the-growth-program-has-no-fallback-under-it) 3583, [The economy re-derived](#the-economy-re-derived-standing-tissue-costs-something) 1355, [Plants that stop](#plants-that-stop-organs-determinacy-and-a-price-on-both) 1537, [The generation loop](#the-generation-loop-plants-die-seeds-expire-slots-come-back) 1303, [Stems draw a line](#stems-draw-a-line-the-growth-walk-renders-its-heading) 1455, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 3758, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 3995, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 4072, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 4687, [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 4327, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 4375, [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 4477, [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 4579 |
| **creatures — worms and the ant colony** | engine | [M18 status](#m18-status) 2018, [The ant colony](#the-ant-colony--status) 3225, [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 4687, [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 4375, [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 4477, [Lab hand-verbs status](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) 4749, [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 4579 |
| **structural collapse, felling and rigid bodies** | outdoor | [M17 status](#m17-status) 1791, [Felling status](#felling-status--the-verb-works-and-what-it-produces-is-pieces) 3758, [Bending status](#bending-status--soft-tissue-lies-over-and-the-wind-is-what-pushes-it) 3995, [Breaking status](#breaking-status--a-badly-grown-tree-comes-down-on-its-own) 4072, [M8 status](#m8-status--started-not-complete) 2485 |
| **fire, heat and phase change** | engine | [M14 status](#m14-status) 820, [Materials](#materials) 247 |
| **explosions, particles and debris** | outdoor | [M15 status](#m15-status) 997, [M7 status](#m7-status) 968 |
| **liquids and gases** | engine | [Liquid physics](#liquid-physics-compressible-volume-not-discrete-occupied-cells) 794, [The coarse field grid](#the-coarse-field-grid) 505 |
| **powders and granular flow** | engine | [Materials](#materials) 247, [Architecture](#architecture) 321 |
| **the coarse field grid — pressure, heat, light** | engine | [The coarse field grid](#the-coarse-field-grid) 505, [M12/M13 status](#m12m13-status) 767, [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 4265 |
| **worldgen and world structure** | outdoor | [M10 status](#m10-status--the-worldgen-half) 3038, [Architecture](#architecture) 321 |
| **the gnome (player character)** | outdoor | [M9 status](#m9-status--the-gnome) 2598, [Controls](#controls) 181 |
| **weather, sky and the clock** | engine | [Weather status](#weather-status) 3208, [M19 status](#m19-status--started) 3686, [World speed](#world-speed--five-independent-time-axes) 5034 |
| **rendering, UI and tunables** | engine | [UI improvements](#ui-improvements--overnight-run-section-9) 2352, [Live tunables panel](#live-tunables-panel--overnight-run-section-10) 2397, [Rendering performance](#rendering-performance--overnight-run-section-11) 2465, [M6 deferral](#m6-deferral) 1128 |
| **performance and the parallel sweep** | engine | [Performance](#performance) 4837, [M5 status](#m5-status) 1138, [Architecture](#architecture) 321, [Rendering performance](#rendering-performance--overnight-run-section-11) 2465, [Lab speed-dial status](#lab-speed-dial-status--what-the-dial-is-actually-short-of) 5252 |
| **materials and the data schema** | engine | [Materials](#materials) 247, [M12/M13 status](#m12m13-status) 767 |
| **the evolution lab — the box and its lights** | lab | [Lab lighting status](#lab-lighting-status--the-fixtures-are-what-light-the-crop) 4265 |
| **reading one specimen off the screen** | lab | [Cell page status](#cell-page-status--the-specimen-readout-is-in-three-groups-and-folds) 4327 |
| **keeping, cloning and mutating an individual** | lab | [Specimen shelf status](#specimen-shelf-status--an-individuals-genetics-outlive-the-box) 4687 |
| **finding one individual among all of them** | lab | [Roster status](#roster-status--every-plant-and-every-animal-as-a-list-you-click-through) 4375 |
| **the genome in plain words** | lab | [Plain-speech status](#plain-speech-status--the-genome-read-back-as-sentences) 4477 |
| **what an individual has done, and what killed it** | lab | [Life record status](#life-record-status--what-an-individual-has-done-and-what-killed-it) 4579 |
| **putting things in the box, and what the view shows** | lab | [Lab hand-verbs status](#lab-hand-verbs-status--what-a-click-puts-in-the-box-and-what-the-view-shows) 4749 |
| **the speed dial, and what a tick costs** | lab | [Lab speed-dial status](#lab-speed-dial-status--what-the-dial-is-actually-short-of) 5252 |
...
place. The second is now `LOST` — past that window the `AtNest` sense the
animal steers home by has decayed to zero, which is the engine's own threshold
rather than an invented one. A state that never varies is a constant with a
column to itself.
...
```
EATS ANYTHING              ANTS HAVE NO EYES
BREEDS AT ITS OWN BAR      LADEN: LAYS FOOD ROUTE
MIDDLING START FOR YOUNG   ALWAYS LAYS HOME SCENT
WALKS RATHER THAN WAITS    LADEN: FOLLOWS HOME SCENT
STOPS DEAD ON FOOD         EMPTY: FOLLOWS FOOD ROUTE
UNLOADS AT THE NEST        CANNOT FEEL HUNGER
                           ANTS DIG NORMALLY
```
