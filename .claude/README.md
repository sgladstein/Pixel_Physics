...
**Always-loaded floor: ~22,978 tokens** — `CLAUDE.md` at 91,912 B / 1,386 lines, bytes/4.0. Ceiling 28,000 (5,022 under). Plus ~430 for the hook, and the harness system prompt and tool schemas on top; this is a floor.

Paid by **every session, agent and subagent** — ten heads is ~229,780 tokens before any of them reads source.
