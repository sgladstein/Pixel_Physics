...
**Always-loaded floor: ~25,168 tokens** — `CLAUDE.md` at 100,671 B / 1,524 lines, bytes/4.0. Ceiling 28,000 (2,832 under). Plus ~430 for the hook, and the harness system prompt and tool schemas on top; this is a floor.

Paid by **every session, agent and subagent** — ten heads is ~251,680 tokens before any of them reads source.
