...
**Always-loaded floor: ~21,640 tokens** — `CLAUDE.md` at 86,560 B / 1,318 lines, bytes/4.0. Ceiling 28,000 (6,360 under). Plus ~430 for the hook, and the harness system prompt and tool schemas on top; this is a floor.

Paid by **every session, agent and subagent** — ten heads is ~216,400 tokens before any of them reads source.
