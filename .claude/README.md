...
**Always-loaded floor: ~25,474 tokens** — `CLAUDE.md` at 101,896 B / 1,584 lines, bytes/4.0. Ceiling 28,000 (2,526 under). Plus ~430 for the hook, and the harness system prompt and tool schemas on top; this is a floor.

Paid by **every session, agent and subagent** — ten heads is ~254,740 tokens before any of them reads source.
