...
**Always-loaded floor: ~25,635 tokens** — `CLAUDE.md` at 102,540 B / 1,591 lines, bytes/4.0. Ceiling 28,000 (2,365 under). Plus ~430 for the hook, and the harness system prompt and tool schemas on top; this is a floor.

Paid by **every session, agent and subagent** — ten heads is ~256,350 tokens before any of them reads source.
