...
**Always-loaded floor: ~25,429 tokens** — `CLAUDE.md` at 101,717 B / 1,583 lines, bytes/4.0. Ceiling 28,000 (2,571 under). Plus ~430 for the hook, and the harness system prompt and tool schemas on top; this is a floor.

Paid by **every session, agent and subagent** — ten heads is ~254,290 tokens before any of them reads source.
