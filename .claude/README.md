...
**Always-loaded floor: ~23,808 tokens** — `CLAUDE.md` at 95,231 B / 1,438 lines, bytes/4.0. Ceiling 28,000 (4,192 under). Plus ~430 for the hook, and the harness system prompt and tool schemas on top; this is a floor.

Paid by **every session, agent and subagent** — ten heads is ~238,080 tokens before any of them reads source.
