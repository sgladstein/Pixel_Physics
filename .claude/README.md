...
**Always-loaded floor: ~23,264 tokens** — `CLAUDE.md` at 93,056 B / 1,400 lines, bytes/4.0. Ceiling 28,000 (4,736 under). Plus ~430 for the hook, and the harness system prompt and tool schemas on top; this is a floor.

Paid by **every session, agent and subagent** — ten heads is ~232,640 tokens before any of them reads source.
