...
'HARNESS ARTIFACT, DO NOT REPORT AS A WORLD BUG: the contact sheet abuts four separately-rendered',
'viewport shots, so a faint vertical seam (sky gradient restart, slight shade step) appears at the',
'shot boundaries -- image x = 512, 1024, 1536. Only features INSIDE a shot are the world\'s.',
'Also: viewshot steps the world between shots, so a traverse doubles as a time-lapse; in the night',
'strip the later shots are later in the day cycle by design.',
'',
